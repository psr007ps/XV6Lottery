...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 cf 7d 10 80 	movl   $0x80107dcf,(%esp)
...
80100a92:	75 d2                	jne    80100a66 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100a94:	e8 37 64 00 00       	call   80106ed0 <setupkvm>
...
80100af6:	e8 f5 61 00 00       	call   80106cf0 <allocuvm>
...
80100b28:	e8 03 61 00 00       	call   80106c30 <loaduvm>
...
80100b72:	e8 d9 62 00 00       	call   80106e50 <freevm>
...
80100baa:	e8 41 61 00 00       	call   80106cf0 <allocuvm>
...
80100bc1:	e8 8a 62 00 00       	call   80106e50 <freevm>
...
80100c06:	e8 65 63 00 00       	call   80106f70 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100c5d:	e8 6e 64 00 00       	call   801070d0 <copyout>
...
80100d34:	e8 67 5d 00 00       	call   80106aa0 <switchuvm>
  freevm(oldpgdir);
80100d39:	89 3c 24             	mov    %edi,(%esp)
80100d3c:	e8 0f 61 00 00       	call   80106e50 <freevm>
  return 0;
...
80101ec8:	68 e6 7a 10 80       	push   $0x80107ae6
...
80101fdb:	68 14 75 10 80       	push   $0x80107514
80101fe0:	e8 ab e3 ff ff       	call   80100390 <panic>
    panic("idestart");
80101fe5:	83 ec 0c             	sub    $0xc,%esp
80101fe8:	68 0b 75 10 80       	push   $0x8010750b
...
801021b9:	e8 e2 1c 00 00       	call   80103ea0 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
801021fa:	68 40 75 10 80       	push   $0x80107540
801021ff:	e8 8c e1 ff ff       	call   80100390 <panic>
    panic("iderw: buf not locked");
80102204:	83 ec 0c             	sub    $0xc,%esp
80102207:	68 2a 75 10 80       	push   $0x8010752a
8010220c:	e8 7f e1 ff ff       	call   80100390 <panic>
    panic("iderw: ide disk 1 not present");
80102211:	83 ec 0c             	sub    $0xc,%esp
80102214:	68 55 75 10 80       	push   $0x80107555
...
80102267:	68 74 75 10 80       	push   $0x80107574
...
80102322:	81 fb a8 5b 11 80    	cmp    $0x80115ba8,%ebx
...
80102395:	68 a6 75 10 80       	push   $0x801075a6
...
801023fb:	68 ac 75 10 80       	push   $0x801075ac
...
80102573:	0f b6 82 e0 76 10 80 	movzbl -0x7fef8920(%edx),%eax
8010257a:	09 c1                	or     %eax,%ecx
  shift ^= togglecode[data];
8010257c:	0f b6 82 e0 75 10 80 	movzbl -0x7fef8a20(%edx),%eax
...
80102590:	83 e1 08             	and    $0x8,%ecx
  c = charcode[shift & (CTL | SHIFT)][data];
80102593:	8b 04 85 c0 75 10 80 	mov    -0x7fef8a40(,%eax,4),%eax
...
801025b5:	0f 44 d0             	cmove  %eax,%edx
    shift &= ~(shiftcode[data] | E0ESC);
801025b8:	0f b6 82 e0 76 10 80 	movzbl -0x7fef8920(%edx),%eax
...
80102b0a:	68 e0 77 10 80       	push   $0x801077e0
...
80102d5f:	68 e4 77 10 80       	push   $0x801077e4
...
80102e29:	68 f3 77 10 80       	push   $0x801077f3
80102e2e:	e8 5d d5 ff ff       	call   80100390 <panic>
    panic("log_write outside of trans");
80102e33:	83 ec 0c             	sub    $0xc,%esp
80102e36:	68 09 78 10 80       	push   $0x80107809
...
80102e47:	e8 44 09 00 00       	call   80103790 <cpuid>
80102e4c:	89 c3                	mov    %eax,%ebx
80102e4e:	e8 3d 09 00 00       	call   80103790 <cpuid>
80102e53:	83 ec 04             	sub    $0x4,%esp
80102e56:	53                   	push   %ebx
80102e57:	50                   	push   %eax
80102e58:	68 24 78 10 80       	push   $0x80107824
80102e5d:	e8 fe d7 ff ff       	call   80100660 <cprintf>
  idtinit();       // load idt register
80102e62:	e8 29 2b 00 00       	call   80105990 <idtinit>
...
80102e83:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e86:	e8 f5 3b 00 00       	call   80106a80 <switchkvm>
  seginit();
80102e8b:	e8 60 3b 00 00       	call   801069f0 <seginit>
  lapicinit();
...
80102eb7:	68 a8 5b 11 80       	push   $0x80115ba8
80102ebc:	e8 2f f5 ff ff       	call   801023f0 <kinit1>
  kvmalloc();      // kernel page table
80102ec1:	e8 8a 40 00 00       	call   80106f50 <kvmalloc>
  mpinit();        // detect other processors
80102ec6:	e8 75 01 00 00       	call   80103040 <mpinit>
  lapicinit();     // interrupt controller
80102ecb:	e8 60 f7 ff ff       	call   80102630 <lapicinit>
  seginit();       // segment descriptors
80102ed0:	e8 1b 3b 00 00       	call   801069f0 <seginit>
  picinit();       // disable pic
...
80102ee4:	e8 d7 2d 00 00       	call   80105cc0 <uartinit>
  pinit();         // process table
80102ee9:	e8 32 08 00 00       	call   80103720 <pinit>
  tvinit();        // trap vectors
80102eee:	e8 1d 2a 00 00       	call   80105910 <tvinit>
  binit();         // buffer cache
...
80102f19:	69 05 10 32 11 80 b0 	imul   $0xb0,0x80113210,%eax
80102f20:	00 00 00 
...
80102f88:	74 f6                	je     80102f80 <main+0xe0>
  for(c = cpus; c < cpus+ncpu; c++){
80102f8a:	69 05 10 32 11 80 b0 	imul   $0xb0,0x80113210,%eax
80102f91:	00 00 00 
...
80102fb5:	e8 26 08 00 00       	call   801037e0 <userinit>
...
80102fee:	68 38 78 10 80       	push   $0x80107838
...
801030ac:	68 55 78 10 80       	push   $0x80107855
...
80103140:	ff 24 95 7c 78 10 80 	jmp    *-0x7fef8784(,%edx,4)
...
80103185:	8d 76 00             	lea    0x0(%esi),%esi
      if(ncpu < NCPU) {
80103188:	8b 0d 10 32 11 80    	mov    0x80113210,%ecx
...
8010319f:	89 0d 10 32 11 80    	mov    %ecx,0x80113210
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
801031a5:	88 97 60 31 11 80    	mov    %dl,-0x7feecea0(%edi)
...
801031b4:	83 c0 08             	add    $0x8,%eax
      ioapicid = ioapic->apicno;
801031b7:	88 15 40 31 11 80    	mov    %dl,0x80113140
      continue;
...
801031eb:	68 3d 78 10 80       	push   $0x8010783d
801031f0:	e8 9b d1 ff ff       	call   80100390 <panic>
    panic("Didn't find a suitable machine");
801031f5:	83 ec 0c             	sub    $0xc,%esp
801031f8:	68 5c 78 10 80       	push   $0x8010785c
...
801032e8:	00 00 00 
  initlock(&p->lock, "pipe");
801032eb:	68 90 78 10 80       	push   $0x80107890
...
8010336f:	e8 ec 0c 00 00       	call   80104060 <wakeup>
...
801033b4:	e8 a7 0c 00 00       	call   80104060 <wakeup>
...
80103444:	e8 17 0c 00 00       	call   80104060 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103449:	5a                   	pop    %edx
8010344a:	59                   	pop    %ecx
8010344b:	53                   	push   %ebx
8010344c:	56                   	push   %esi
8010344d:	e8 4e 0a 00 00       	call   80103ea0 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
80103474:	e8 37 03 00 00       	call   801037b0 <myproc>
...
801034d3:	e8 88 0b 00 00       	call   80104060 <wakeup>
  release(&p->lock);
...
80103535:	e8 66 09 00 00       	call   80103ea0 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
80103553:	0f 84 8f 00 00 00    	je     801035e8 <piperead+0xf8>
    if(myproc()->killed){
80103559:	e8 52 02 00 00       	call   801037b0 <myproc>
...
801035c7:	e8 94 0a 00 00       	call   80104060 <wakeup>
  release(&p->lock);
...
801035f4:	bb 54 32 11 80       	mov    $0x80113254,%ebx
{
801035f9:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
801035fc:	68 20 32 11 80       	push   $0x80113220
...
80103616:	81 fb 54 53 11 80    	cmp    $0x80115354,%ebx
8010361c:	0f 83 7e 00 00 00    	jae    801036a0 <allocproc+0xb0>
    if(p->state == UNUSED)
...
80103631:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->tickets = 10;																//lottery
80103638:	c7 43 7c 0a 00 00 00 	movl   $0xa,0x7c(%ebx)
  p->pid = nextpid++;
8010363f:	8d 50 01             	lea    0x1(%eax),%edx
80103642:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103645:	68 20 32 11 80       	push   $0x80113220
  p->pid = nextpid++;
8010364a:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103650:	e8 2b 0f 00 00       	call   80104580 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
80103655:	e8 66 ee ff ff       	call   801024c0 <kalloc>
8010365a:	83 c4 10             	add    $0x10,%esp
8010365d:	85 c0                	test   %eax,%eax
8010365f:	89 43 08             	mov    %eax,0x8(%ebx)
80103662:	74 55                	je     801036b9 <allocproc+0xc9>
    return 0;
  }
  ...
  sp -= sizeof *p->tf;
80103664:	8d 90 b4 0f 00 00    	lea    0xfb4(%eax),%edx
  sp -= 4;
...
8010366a:	83 ec 04             	sub    $0x4,%esp
  sp -= sizeof *p->context;
8010366d:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *p->tf;
80103672:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103675:	c7 40 14 f8 58 10 80 	movl   $0x801058f8,0x14(%eax)
  p->context = (struct context*)sp;
8010367c:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
8010367f:	6a 14                	push   $0x14
80103681:	6a 00                	push   $0x0
80103683:	50                   	push   %eax
80103684:	e8 47 0f 00 00       	call   801045d0 <memset>
  p->context->eip = (uint)forkret;
80103689:	8b 43 1c             	mov    0x1c(%ebx),%eax

  return p;
8010368c:	83 c4 10             	add    $0x10,%esp
  p->context->eip = (uint)forkret;
8010368f:	c7 40 10 d0 36 10 80 	movl   $0x801036d0,0x10(%eax)
}
80103696:	89 d8                	mov    %ebx,%eax
80103698:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010369b:	c9                   	leave  
8010369c:	c3                   	ret    
...
801036a3:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
801036a5:	68 20 32 11 80       	push   $0x80113220
801036aa:	e8 d1 0e 00 00       	call   80104580 <release>
}
...
801036c2:	eb d2                	jmp    80103696 <allocproc+0xa6>
...
801036d3:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
801036d6:	68 20 32 11 80       	push   $0x80113220
801036db:	e8 a0 0e 00 00       	call   80104580 <release>
...
80103726:	68 95 78 10 80       	push   $0x80107895
8010372b:	68 20 32 11 80       	push   $0x80113220
80103730:	e8 4b 0c 00 00       	call   80104380 <initlock>
}
...
8010379b:	2d 60 31 11 80       	sub    $0x80113160,%eax
}
801037a0:	c9                   	leave  
  return mycpu()-cpus;
...
801037b4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801037b7:	e8 34 0c 00 00       	call   801043f0 <pushcli>
  c = mycpu();
801037bc:	e8 7f ff ff ff       	call   80103740 <mycpu>
  p = c->proc;
801037c1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801037c7:	e8 64 0c 00 00       	call   80104430 <popcli>
}
...
801037e4:	83 ec 04             	sub    $0x4,%esp
  p = allocproc();
801037e7:	e8 04 fe ff ff       	call   801035f0 <allocproc>
801037ec:	89 c3                	mov    %eax,%ebx
  initproc = p;
801037ee:	a3 b8 a5 10 80       	mov    %eax,0x8010a5b8
  if((p->pgdir = setupkvm()) == 0)
801037f3:	e8 d8 36 00 00       	call   80106ed0 <setupkvm>
...
80103811:	e8 9a 33 00 00       	call   80106bb0 <inituvm>
...
8010387f:	68 c5 78 10 80       	push   $0x801078c5
80103884:	50                   	push   %eax
80103885:	e8 26 0f 00 00       	call   801047b0 <safestrcpy>
  p->cwd = namei("/");
8010388a:	c7 04 24 ce 78 10 80 	movl   $0x801078ce,(%esp)
80103891:	e8 4a e6 ff ff       	call   80101ee0 <namei>
80103896:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103899:	c7 04 24 20 32 11 80 	movl   $0x80113220,(%esp)
801038a0:	e8 1b 0c 00 00       	call   801044c0 <acquire>
  p->state = RUNNABLE;
801038a5:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
801038ac:	c7 04 24 20 32 11 80 	movl   $0x80113220,(%esp)
801038b3:	e8 c8 0c 00 00       	call   80104580 <release>
}
...
801038c3:	68 ac 78 10 80       	push   $0x801078ac
...
801038fc:	e8 9f 31 00 00       	call   80106aa0 <switchuvm>
  return 0;
...
8010391a:	e8 d1 33 00 00       	call   80106cf0 <allocuvm>
...
8010393a:	e8 e1 34 00 00       	call   80106e20 <deallocuvm>
...
801039cc:	e8 1f d4 ff ff       	call   80100df0 <filedup>
...
801039e9:	83 c3 6c             	add    $0x6c,%ebx
  np->cwd = idup(curproc->cwd);
801039ec:	e8 5f dc ff ff       	call   80101650 <idup>
...
80103a01:	e8 aa 0d 00 00       	call   801047b0 <safestrcpy>
  pid = np->pid;
80103a06:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103a09:	c7 04 24 20 32 11 80 	movl   $0x80113220,(%esp)
80103a10:	e8 ab 0a 00 00       	call   801044c0 <acquire>
  np->state = RUNNABLE;
80103a15:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103a1c:	c7 04 24 20 32 11 80 	movl   $0x80113220,(%esp)
80103a23:	e8 58 0b 00 00       	call   80104580 <release>
  return pid;
80103a28:	83 c4 10             	add    $0x10,%esp
}
80103a2b:	8d 65 f4             	lea    -0xc(%ebp),%esp
80103a2e:	89 d8                	mov    %ebx,%eax
80103a30:	5b                   	pop    %ebx
80103a31:	5e                   	pop    %esi
80103a32:	5f                   	pop    %edi
80103a33:	5d                   	pop    %ebp
80103a34:	c3                   	ret    
    return -1;
80103a35:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103a3a:	eb ef                	jmp    80103a2b <fork+0xdb>
    kfree(np->kstack);
80103a3c:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80103a3f:	83 ec 0c             	sub    $0xc,%esp
80103a42:	ff 73 08             	pushl  0x8(%ebx)
80103a45:	e8 c6 e8 ff ff       	call   80102310 <kfree>
    np->kstack = 0;
80103a4a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    np->state = UNUSED;
80103a51:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return -1;
80103a58:	83 c4 10             	add    $0x10,%esp
80103a5b:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103a60:	eb c9                	jmp    80103a2b <fork+0xdb>
80103a62:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103a69:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

80103a70 <lottery_Total>:
int lottery_Total(void){
80103a70:	55                   	push   %ebp
  int ticket_aggregate=0;
80103a71:	31 c0                	xor    %eax,%eax
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103a73:	ba 54 32 11 80       	mov    $0x80113254,%edx
int lottery_Total(void){
80103a78:	89 e5                	mov    %esp,%ebp
80103a7a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(p->state==RUNNABLE){
80103a80:	83 7a 0c 03          	cmpl   $0x3,0xc(%edx)
80103a84:	75 03                	jne    80103a89 <lottery_Total+0x19>
      ticket_aggregate+=p->tickets;
80103a86:	03 42 7c             	add    0x7c(%edx),%eax
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103a89:	81 c2 84 00 00 00    	add    $0x84,%edx
80103a8f:	81 fa 54 53 11 80    	cmp    $0x80115354,%edx
80103a95:	72 e9                	jb     80103a80 <lottery_Total+0x10>
}
80103a97:	5d                   	pop    %ebp
80103a98:	c3                   	ret    
...
80103ac4:	68 20 32 11 80       	push   $0x80113220
80103ac9:	e8 f2 09 00 00       	call   801044c0 <acquire>
80103ace:	83 c4 10             	add    $0x10,%esp
  int ticket_aggregate=0;
80103ad1:	31 d2                	xor    %edx,%edx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ad3:	b8 54 32 11 80       	mov    $0x80113254,%eax
80103ad8:	90                   	nop
80103ad9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(p->state==RUNNABLE){
80103ae0:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103ae4:	75 03                	jne    80103ae9 <scheduler+0x49>
      ticket_aggregate+=p->tickets;
80103ae6:	03 50 7c             	add    0x7c(%eax),%edx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ae9:	05 84 00 00 00       	add    $0x84,%eax
80103aee:	3d 54 53 11 80       	cmp    $0x80115354,%eax
80103af3:	72 eb                	jb     80103ae0 <scheduler+0x40>
    golden_ticket = random_at_most(total_no_tickets);
80103af5:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103af8:	bf 54 32 11 80       	mov    $0x80113254,%edi
    golden_ticket = random_at_most(total_no_tickets);
80103afd:	52                   	push   %edx
80103afe:	e8 fd 37 00 00       	call   80107300 <random_at_most>
80103b03:	83 c4 10             	add    $0x10,%esp
    count = 0;
80103b06:	31 d2                	xor    %edx,%edx
      if(p->state != RUNNABLE)
80103b08:	83 7f 0c 03          	cmpl   $0x3,0xc(%edi)
80103b0c:	75 5a                	jne    80103b68 <scheduler+0xc8>
      if ((count + p->tickets) < golden_ticket){
80103b0e:	03 57 7c             	add    0x7c(%edi),%edx
80103b11:	39 c2                	cmp    %eax,%edx
80103b13:	7c 53                	jl     80103b68 <scheduler+0xc8>
      switchuvm(p);
80103b15:	83 ec 0c             	sub    $0xc,%esp
      c->proc = p;
80103b18:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
      switchuvm(p);
80103b1e:	57                   	push   %edi
80103b1f:	e8 7c 2f 00 00       	call   80106aa0 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103b24:	58                   	pop    %eax
80103b25:	5a                   	pop    %edx
80103b26:	ff 77 1c             	pushl  0x1c(%edi)
80103b29:	56                   	push   %esi
      p->state = RUNNING;
80103b2a:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
	    p->usage=p->usage+1;
80103b31:	83 87 80 00 00 00 01 	addl   $0x1,0x80(%edi)
      swtch(&(c->scheduler), p->context);
80103b38:	e8 ce 0c 00 00       	call   8010480b <swtch>
      switchkvm();
80103b3d:	e8 3e 2f 00 00       	call   80106a80 <switchkvm>
      c->proc = 0;
80103b42:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103b49:	00 00 00 
	  break;															//lottery
80103b4c:	83 c4 10             	add    $0x10,%esp
    release(&ptable.lock);
80103b4f:	83 ec 0c             	sub    $0xc,%esp
80103b52:	68 20 32 11 80       	push   $0x80113220
80103b57:	e8 24 0a 00 00       	call   80104580 <release>
    sti();
80103b5c:	83 c4 10             	add    $0x10,%esp
80103b5f:	e9 5c ff ff ff       	jmp    80103ac0 <scheduler+0x20>
80103b64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b68:	81 c7 84 00 00 00    	add    $0x84,%edi
80103b6e:	81 ff 54 53 11 80    	cmp    $0x80115354,%edi
80103b74:	72 92                	jb     80103b08 <scheduler+0x68>
80103b76:	eb d7                	jmp    80103b4f <scheduler+0xaf>
80103b78:	90                   	nop
...
80103b84:	53                   	push   %ebx
  pushcli();
80103b85:	e8 66 08 00 00       	call   801043f0 <pushcli>
  c = mycpu();
80103b8a:	e8 b1 fb ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103b8f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b95:	e8 96 08 00 00       	call   80104430 <popcli>
  if(!holding(&ptable.lock))
80103b9a:	83 ec 0c             	sub    $0xc,%esp
80103b9d:	68 20 32 11 80       	push   $0x80113220
80103ba2:	e8 e9 08 00 00       	call   80104490 <holding>
80103ba7:	83 c4 10             	add    $0x10,%esp
80103baa:	85 c0                	test   %eax,%eax
80103bac:	74 4f                	je     80103bfd <sched+0x7d>
  if(mycpu()->ncli != 1)
80103bae:	e8 8d fb ff ff       	call   80103740 <mycpu>
...
80103bc7:	75 41                	jne    80103c0a <sched+0x8a>
  intena = mycpu()->intena;
80103bc9:	e8 72 fb ff ff       	call   80103740 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103bce:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103bd1:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103bd7:	e8 64 fb ff ff       	call   80103740 <mycpu>
...
80103be3:	e8 23 0c 00 00       	call   8010480b <swtch>
  mycpu()->intena = intena;
80103be8:	e8 53 fb ff ff       	call   80103740 <mycpu>
}
...
80103c45:	53                   	push   %ebx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c46:	bf 54 32 11 80       	mov    $0x80113254,%edi
{
80103c4b:	83 ec 2c             	sub    $0x2c,%esp
  pushcli();
80103c4e:	e8 9d 07 00 00       	call   801043f0 <pushcli>
  c = mycpu();
80103c53:	e8 e8 fa ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103c58:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80103c5e:	89 45 d4             	mov    %eax,-0x2c(%ebp)
  popcli();
80103c61:	e8 ca 07 00 00       	call   80104430 <popcli>
80103c66:	8d 76 00             	lea    0x0(%esi),%esi
80103c69:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    if(p->state == UNUSED)
80103c70:	8b 47 0c             	mov    0xc(%edi),%eax
80103c73:	85 c0                	test   %eax,%eax
80103c75:	0f 84 84 00 00 00    	je     80103cff <exit+0xbf>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103c7b:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103c7e:	be 10 79 10 80       	mov    $0x80107910,%esi
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103c83:	77 11                	ja     80103c96 <exit+0x56>
80103c85:	8b 34 85 d8 79 10 80 	mov    -0x7fef8628(,%eax,4),%esi
      state = "???";
80103c8c:	b8 10 79 10 80       	mov    $0x80107910,%eax
80103c91:	85 f6                	test   %esi,%esi
80103c93:	0f 44 f0             	cmove  %eax,%esi
	cprintf("From  %s-%d: %d %s %s sched_times=%d ticket=%d \n", myproc()->name, myproc()->pid, p->pid, state, p->name, p->usage, p->tickets);
80103c96:	8b 57 10             	mov    0x10(%edi),%edx
80103c99:	8b 4f 7c             	mov    0x7c(%edi),%ecx
80103c9c:	8b 87 80 00 00 00    	mov    0x80(%edi),%eax
80103ca2:	89 55 e0             	mov    %edx,-0x20(%ebp)
80103ca5:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80103ca8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  pushcli();
80103cab:	e8 40 07 00 00       	call   801043f0 <pushcli>
  c = mycpu();
80103cb0:	e8 8b fa ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103cb5:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103cbb:	e8 70 07 00 00       	call   80104430 <popcli>
	cprintf("From  %s-%d: %d %s %s sched_times=%d ticket=%d \n", myproc()->name, myproc()->pid, p->pid, state, p->name, p->usage, p->tickets);
80103cc0:	8b 5b 10             	mov    0x10(%ebx),%ebx
  pushcli();
80103cc3:	e8 28 07 00 00       	call   801043f0 <pushcli>
  c = mycpu();
80103cc8:	e8 73 fa ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103ccd:	8b 88 ac 00 00 00    	mov    0xac(%eax),%ecx
80103cd3:	89 4d dc             	mov    %ecx,-0x24(%ebp)
  popcli();
80103cd6:	e8 55 07 00 00       	call   80104430 <popcli>
	cprintf("From  %s-%d: %d %s %s sched_times=%d ticket=%d \n", myproc()->name, myproc()->pid, p->pid, state, p->name, p->usage, p->tickets);
80103cdb:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80103cde:	8d 47 6c             	lea    0x6c(%edi),%eax
80103ce1:	51                   	push   %ecx
80103ce2:	8b 4d dc             	mov    -0x24(%ebp),%ecx
80103ce5:	ff 75 e4             	pushl  -0x1c(%ebp)
80103ce8:	50                   	push   %eax
80103ce9:	56                   	push   %esi
80103cea:	ff 75 e0             	pushl  -0x20(%ebp)
80103ced:	53                   	push   %ebx
80103cee:	8d 59 6c             	lea    0x6c(%ecx),%ebx
80103cf1:	53                   	push   %ebx
80103cf2:	68 a4 79 10 80       	push   $0x801079a4
80103cf7:	e8 64 c9 ff ff       	call   80100660 <cprintf>
80103cfc:	83 c4 20             	add    $0x20,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cff:	81 c7 84 00 00 00    	add    $0x84,%edi
80103d05:	81 ff 54 53 11 80    	cmp    $0x80115354,%edi
80103d0b:	0f 82 5f ff ff ff    	jb     80103c70 <exit+0x30>
80103d11:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  if(curproc == initproc)
80103d14:	39 05 b8 a5 10 80    	cmp    %eax,0x8010a5b8
80103d1a:	8d 58 28             	lea    0x28(%eax),%ebx
80103d1d:	8d 70 68             	lea    0x68(%eax),%esi
80103d20:	0f 84 0e 01 00 00    	je     80103e34 <exit+0x1f4>
...
80103d34:	74 12                	je     80103d48 <exit+0x108>
...
80103d4b:	39 f3                	cmp    %esi,%ebx
80103d4d:	75 e1                	jne    80103d30 <exit+0xf0>
  begin_op();
80103d4f:	e8 4c ee ff ff       	call   80102ba0 <begin_op>
  iput(curproc->cwd);
80103d54:	8b 75 d4             	mov    -0x2c(%ebp),%esi
80103d57:	83 ec 0c             	sub    $0xc,%esp
80103d5a:	ff 76 68             	pushl  0x68(%esi)
80103d5d:	e8 4e da ff ff       	call   801017b0 <iput>
  end_op();
80103d62:	e8 a9 ee ff ff       	call   80102c10 <end_op>
  curproc->cwd = 0;
80103d67:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103d6e:	c7 04 24 20 32 11 80 	movl   $0x80113220,(%esp)
80103d75:	e8 46 07 00 00       	call   801044c0 <acquire>
  wakeup1(curproc->parent);
80103d7a:	8b 56 14             	mov    0x14(%esi),%edx
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d80:	b8 54 32 11 80       	mov    $0x80113254,%eax
80103d85:	eb 15                	jmp    80103d9c <exit+0x15c>
80103d87:	89 f6                	mov    %esi,%esi
80103d89:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
80103d90:	05 84 00 00 00       	add    $0x84,%eax
80103d95:	3d 54 53 11 80       	cmp    $0x80115354,%eax
80103d9a:	73 1e                	jae    80103dba <exit+0x17a>
    if(p->state == SLEEPING && p->chan == chan)
80103d9c:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103da0:	75 ee                	jne    80103d90 <exit+0x150>
80103da2:	3b 50 20             	cmp    0x20(%eax),%edx
80103da5:	75 e9                	jne    80103d90 <exit+0x150>
      p->state = RUNNABLE;
80103da7:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103dae:	05 84 00 00 00       	add    $0x84,%eax
80103db3:	3d 54 53 11 80       	cmp    $0x80115354,%eax
80103db8:	72 e2                	jb     80103d9c <exit+0x15c>
      p->parent = initproc;
80103dba:	8b 0d b8 a5 10 80    	mov    0x8010a5b8,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103dc0:	ba 54 32 11 80       	mov    $0x80113254,%edx
80103dc5:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
80103dc8:	eb 14                	jmp    80103dde <exit+0x19e>
80103dca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80103dd0:	81 c2 84 00 00 00    	add    $0x84,%edx
80103dd6:	81 fa 54 53 11 80    	cmp    $0x80115354,%edx
80103ddc:	73 3a                	jae    80103e18 <exit+0x1d8>
    if(p->parent == curproc){
80103dde:	39 5a 14             	cmp    %ebx,0x14(%edx)
80103de1:	75 ed                	jne    80103dd0 <exit+0x190>
      if(p->state == ZOMBIE)
80103de3:	83 7a 0c 05          	cmpl   $0x5,0xc(%edx)
      p->parent = initproc;
80103de7:	89 4a 14             	mov    %ecx,0x14(%edx)
      if(p->state == ZOMBIE)
80103dea:	75 e4                	jne    80103dd0 <exit+0x190>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103dec:	b8 54 32 11 80       	mov    $0x80113254,%eax
80103df1:	eb 11                	jmp    80103e04 <exit+0x1c4>
80103df3:	90                   	nop
80103df4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103df8:	05 84 00 00 00       	add    $0x84,%eax
80103dfd:	3d 54 53 11 80       	cmp    $0x80115354,%eax
80103e02:	73 cc                	jae    80103dd0 <exit+0x190>
    if(p->state == SLEEPING && p->chan == chan)
80103e04:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103e08:	75 ee                	jne    80103df8 <exit+0x1b8>
80103e0a:	3b 48 20             	cmp    0x20(%eax),%ecx
80103e0d:	75 e9                	jne    80103df8 <exit+0x1b8>
      p->state = RUNNABLE;
80103e0f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
80103e16:	eb e0                	jmp    80103df8 <exit+0x1b8>
  curproc->state = ZOMBIE;
80103e18:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80103e1b:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
80103e22:	e8 59 fd ff ff       	call   80103b80 <sched>
  panic("zombie exit");
80103e27:	83 ec 0c             	sub    $0xc,%esp
80103e2a:	68 21 79 10 80       	push   $0x80107921
80103e2f:	e8 5c c5 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103e34:	83 ec 0c             	sub    $0xc,%esp
80103e37:	68 14 79 10 80       	push   $0x80107914
80103e3c:	e8 4f c5 ff ff       	call   80100390 <panic>
80103e41:	eb 0d                	jmp    80103e50 <yield>
80103e43:	90                   	nop
80103e44:	90                   	nop
80103e45:	90                   	nop
80103e46:	90                   	nop
...
80103e57:	68 20 32 11 80       	push   $0x80113220
80103e5c:	e8 5f 06 00 00       	call   801044c0 <acquire>
  pushcli();
80103e61:	e8 8a 05 00 00       	call   801043f0 <pushcli>
  c = mycpu();
80103e66:	e8 d5 f8 ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103e6b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e71:	e8 ba 05 00 00       	call   80104430 <popcli>
  myproc()->state = RUNNABLE;
80103e76:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
80103e7d:	e8 fe fc ff ff       	call   80103b80 <sched>
  release(&ptable.lock);
80103e82:	c7 04 24 20 32 11 80 	movl   $0x80113220,(%esp)
80103e89:	e8 f2 06 00 00       	call   80104580 <release>
}
...
80103eac:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103eaf:	e8 3c 05 00 00       	call   801043f0 <pushcli>
  c = mycpu();
80103eb4:	e8 87 f8 ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103eb9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ebf:	e8 6c 05 00 00       	call   80104430 <popcli>
  if(p == 0)
...
80103ed0:	81 fe 20 32 11 80    	cmp    $0x80113220,%esi
80103ed6:	74 50                	je     80103f28 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103ed8:	83 ec 0c             	sub    $0xc,%esp
80103edb:	68 20 32 11 80       	push   $0x80113220
80103ee0:	e8 db 05 00 00       	call   801044c0 <acquire>
    release(lk);
80103ee5:	89 34 24             	mov    %esi,(%esp)
80103ee8:	e8 93 06 00 00       	call   80104580 <release>
  p->chan = chan;
80103eed:	89 7b 20             	mov    %edi,0x20(%ebx)
  p->state = SLEEPING;
80103ef0:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103ef7:	e8 84 fc ff ff       	call   80103b80 <sched>
  p->chan = 0;
80103efc:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80103f03:	c7 04 24 20 32 11 80 	movl   $0x80113220,(%esp)
80103f0a:	e8 71 06 00 00       	call   80104580 <release>
    acquire(lk);
...
80103f1b:	5d                   	pop    %ebp
    acquire(lk);
80103f1c:	e9 9f 05 00 00       	jmp    801044c0 <acquire>
...
80103f2b:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103f32:	e8 49 fc ff ff       	call   80103b80 <sched>
  p->chan = 0;
...
80103f49:	68 33 79 10 80       	push   $0x80107933
80103f4e:	e8 3d c4 ff ff       	call   80100390 <panic>
    panic("sleep");
80103f53:	83 ec 0c             	sub    $0xc,%esp
80103f56:	68 2d 79 10 80       	push   $0x8010792d
...
80103fb7:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fbc:	81 fb 54 53 11 80    	cmp    $0x80115354,%ebx
...
80103fd2:	68 20 32 11 80       	push   $0x80113220
...
80103fee:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80103ff1:	e8 1a e3 ff ff       	call   80102310 <kfree>
        freevm(p->pgdir);
80103ff6:	5a                   	pop    %edx
...
80103ffa:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104001:	e8 4a 2e 00 00       	call   80106e50 <freevm>
        release(&ptable.lock);
80104006:	c7 04 24 20 32 11 80 	movl   $0x80113220,(%esp)
        p->pid = 0;
...
80104026:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
8010402d:	e8 4e 05 00 00       	call   80104580 <release>
        return pid;
...
80104041:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80104046:	68 20 32 11 80       	push   $0x80113220
8010404b:	e8 30 05 00 00       	call   80104580 <release>
      return -1;
...
80104067:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
8010406a:	68 20 32 11 80       	push   $0x80113220
8010406f:	e8 4c 04 00 00       	call   801044c0 <acquire>
80104074:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104077:	b8 54 32 11 80       	mov    $0x80113254,%eax
...
801040a8:	72 e2                	jb     8010408c <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
801040aa:	c7 45 08 20 32 11 80 	movl   $0x80113220,0x8(%ebp)
}
801040b1:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801040b4:	c9                   	leave  
  release(&ptable.lock);
801040b5:	e9 c6 04 00 00       	jmp    80104580 <release>
...
801040c7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
801040ca:	68 20 32 11 80       	push   $0x80113220
801040cf:	e8 ec 03 00 00       	call   801044c0 <acquire>
801040d4:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040d7:	b8 54 32 11 80       	mov    $0x80113254,%eax
801040dc:	eb 0e                	jmp    801040ec <kill+0x2c>
801040de:	66 90                	xchg   %ax,%ax
801040e0:	05 84 00 00 00       	add    $0x84,%eax
801040e5:	3d 54 53 11 80       	cmp    $0x80115354,%eax
...
80104108:	68 20 32 11 80       	push   $0x80113220
8010410d:	e8 6e 04 00 00       	call   80104580 <release>
      return 0;
...
80104123:	68 20 32 11 80       	push   $0x80113220
80104128:	e8 53 04 00 00       	call   80104580 <release>
  return -1;
...
80104146:	8d 75 e8             	lea    -0x18(%ebp),%esi
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104149:	bb 54 32 11 80       	mov    $0x80113254,%ebx
{
...
8010415b:	68 cf 7d 10 80       	push   $0x80107dcf
...
80104174:	0f 83 96 00 00 00    	jae    80104210 <procdump+0xd0>
    if(p->state == UNUSED)
...
80104181:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104184:	ba 10 79 10 80       	mov    $0x80107910,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104189:	77 11                	ja     8010419c <procdump+0x5c>
8010418b:	8b 14 85 d8 79 10 80 	mov    -0x7fef8628(,%eax,4),%edx
      state = "???";
80104192:	b8 10 79 10 80       	mov    $0x80107910,%eax
...
801041a2:	ff 73 7c             	pushl  0x7c(%ebx)
801041a5:	50                   	push   %eax
801041a6:	52                   	push   %edx
801041a7:	ff 73 10             	pushl  0x10(%ebx)
801041aa:	68 44 79 10 80       	push   $0x80107944
801041af:	e8 ac c4 ff ff       	call   80100660 <cprintf>
    if(p->state == SLEEPING){
801041b4:	83 c4 20             	add    $0x20,%esp
801041b7:	83 7b 0c 02          	cmpl   $0x2,0xc(%ebx)
801041bb:	75 9b                	jne    80104158 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
801041bd:	8d 45 c0             	lea    -0x40(%ebp),%eax
801041c0:	83 ec 08             	sub    $0x8,%esp
801041c3:	8d 7d c0             	lea    -0x40(%ebp),%edi
801041c6:	50                   	push   %eax
801041c7:	8b 43 1c             	mov    0x1c(%ebx),%eax
801041ca:	8b 40 0c             	mov    0xc(%eax),%eax
801041cd:	83 c0 08             	add    $0x8,%eax
801041d0:	50                   	push   %eax
801041d1:	e8 ca 01 00 00       	call   801043a0 <getcallerpcs>
...
801041e4:	0f 84 6e ff ff ff    	je     80104158 <procdump+0x18>
        cprintf(" %p", pc[i]);
801041ea:	83 ec 08             	sub    $0x8,%esp
801041ed:	83 c7 04             	add    $0x4,%edi
801041f0:	52                   	push   %edx
801041f1:	68 81 73 10 80       	push   $0x80107381
...
80104202:	e9 51 ff ff ff       	jmp    80104158 <procdump+0x18>
...
80104221:	31 c0                	xor    %eax,%eax
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104223:	ba 54 32 11 80       	mov    $0x80113254,%edx
{
...
8010422a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    count++;
80104230:	83 7a 0c 01          	cmpl   $0x1,0xc(%edx)
80104234:	83 d8 ff             	sbb    $0xffffffff,%eax
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104237:	81 c2 84 00 00 00    	add    $0x84,%edx
8010423d:	81 fa 54 53 11 80    	cmp    $0x80115354,%edx
80104243:	72 eb                	jb     80104230 <procCount+0x10>
    }
...
8010425a:	68 f0 79 10 80       	push   $0x801079f0
...
801042b5:	e8 e6 fb ff ff       	call   80103ea0 <sleep>
  while (lk->locked) {
...
801042c3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801042c9:	e8 e2 f4 ff ff       	call   801037b0 <myproc>
...
80104314:	e8 47 fd ff ff       	call   80104060 <wakeup>
  release(&lk->lk);
...
80104353:	e8 58 f4 ff ff       	call   801037b0 <myproc>
...
8010440f:	e8 2c f3 ff ff       	call   80103740 <mycpu>
...
8010445c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104460:	e8 db f2 ff ff       	call   80103740 <mycpu>
...
80104475:	68 fb 79 10 80       	push   $0x801079fb
8010447a:	e8 11 bf ff ff       	call   80100390 <panic>
    panic("popcli");
8010447f:	83 ec 0c             	sub    $0xc,%esp
80104482:	68 12 7a 10 80       	push   $0x80107a12
...
801044a8:	e8 93 f2 ff ff       	call   80103740 <mycpu>
...
80104504:	e8 37 f2 ff ff       	call   80103740 <mycpu>
...
80104567:	68 19 7a 10 80       	push   $0x80107a19
...
801045bc:	68 21 7a 10 80       	push   $0x80107a21
...
80104827:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010482a:	e8 81 ef ff ff       	call   801037b0 <myproc>
...
80104867:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010486a:	e8 41 ef ff ff       	call   801037b0 <myproc>
...
801048d5:	e8 d6 ee ff ff       	call   801037b0 <myproc>
...
801048e3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801048e6:	e8 c5 ee ff ff       	call   801037b0 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104928:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010492b:	e8 80 ee ff ff       	call   801037b0 <myproc>
...
801049c5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct proc *curproc = myproc();
801049c8:	e8 e3 ed ff ff       	call   801037b0 <myproc>
...
801049d2:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
801049d5:	8d 50 ff             	lea    -0x1(%eax),%edx
801049d8:	83 fa 16             	cmp    $0x16,%edx
801049db:	77 53                	ja     80104a30 <syscall+0x70>
801049dd:	8b 14 85 60 7a 10 80 	mov    -0x7fef85a0(,%eax,4),%edx
801049e4:	8d 73 6c             	lea    0x6c(%ebx),%esi
801049e7:	85 d2                	test   %edx,%edx
801049e9:	74 48                	je     80104a33 <syscall+0x73>
    curproc->tf->eax = syscalls[num]();
801049eb:	ff d2                	call   *%edx
801049ed:	8b 53 18             	mov    0x18(%ebx),%edx
	char currentProcess[] = "mycode";
	
	if (strncmp(curproc->name,currentProcess,6)==0)
801049f0:	83 ec 04             	sub    $0x4,%esp
	char currentProcess[] = "mycode";
801049f3:	c7 45 f1 6d 79 63 6f 	movl   $0x6f63796d,-0xf(%ebp)
801049fa:	c6 45 f7 00          	movb   $0x0,-0x9(%ebp)
    curproc->tf->eax = syscalls[num]();
801049fe:	89 42 1c             	mov    %eax,0x1c(%edx)
	char currentProcess[] = "mycode";
80104a01:	b8 64 65 00 00       	mov    $0x6564,%eax
	if (strncmp(curproc->name,currentProcess,6)==0)
80104a06:	6a 06                	push   $0x6
	char currentProcess[] = "mycode";
80104a08:	66 89 45 f5          	mov    %ax,-0xb(%ebp)
	if (strncmp(curproc->name,currentProcess,6)==0)
80104a0c:	8d 45 f1             	lea    -0xf(%ebp),%eax
80104a0f:	50                   	push   %eax
80104a10:	56                   	push   %esi
80104a11:	e8 da fc ff ff       	call   801046f0 <strncmp>
80104a16:	83 c4 10             	add    $0x10,%esp
80104a19:	85 c0                	test   %eax,%eax
80104a1b:	75 07                	jne    80104a24 <syscall+0x64>
	{
		
	numcalls++;
80104a1d:	83 05 bc a5 10 80 01 	addl   $0x1,0x8010a5bc
  } else {
...
80104a24:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104a27:	5b                   	pop    %ebx
80104a28:	5e                   	pop    %esi
80104a29:	5d                   	pop    %ebp
80104a2a:	c3                   	ret    
...
80104a30:	8d 73 6c             	lea    0x6c(%ebx),%esi
    cprintf("%d %s: unknown sys call %d\n",
80104a33:	50                   	push   %eax
80104a34:	56                   	push   %esi
80104a35:	ff 73 10             	pushl  0x10(%ebx)
80104a38:	68 29 7a 10 80       	push   $0x80107a29
80104a3d:	e8 1e bc ff ff       	call   80100660 <cprintf>
    curproc->tf->eax = -1;
...
80104b94:	68 dc 7a 10 80       	push   $0x80107adc
...
80104bac:	68 db 7a 10 80       	push   $0x80107adb
...
80104bc5:	68 cf 7a 10 80       	push   $0x80107acf
...
80104bda:	68 de 7a 10 80       	push   $0x80107ade
80104bdf:	e8 ac b7 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104be4:	83 ec 0c             	sub    $0xc,%esp
80104be7:	68 c0 7a 10 80       	push   $0x80107ac0
...
80104c12:	e8 b9 fc ff ff       	call   801048d0 <argint>
...
80104c24:	e8 87 eb ff ff       	call   801037b0 <myproc>
...
80104c69:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104c6b:	e8 40 eb ff ff       	call   801037b0 <myproc>
...
80104cdd:	e8 ee fb ff ff       	call   801048d0 <argint>
...
80104d4d:	e8 7e fb ff ff       	call   801048d0 <argint>
...
80104db3:	78 2b                	js     80104de0 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104db5:	e8 f6 e9 ff ff       	call   801037b0 <myproc>
...
80104e4f:	e8 2c fb ff ff       	call   80104980 <argstr>
...
80104e68:	e8 13 fb ff ff       	call   80104980 <argstr>
...
80104f9f:	e8 dc f9 ff ff       	call   80104980 <argstr>
...
80104fd9:	58                   	pop    %eax
80104fda:	5a                   	pop    %edx
80104fdb:	68 dc 7a 10 80       	push   $0x80107adc
...
80104ff4:	68 db 7a 10 80       	push   $0x80107adb
...
8010504e:	e8 7d f5 ff ff       	call   801045d0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
8010517f:	e8 fc f7 ff ff       	call   80104980 <argstr>
...
80105198:	e8 33 f7 ff ff       	call   801048d0 <argint>
...
801051ef:	0f 84 a6 00 00 00    	je     8010529b <sys_open+0x12b>
  struct proc *curproc = myproc();
801051f5:	e8 b6 e5 ff ff       	call   801037b0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105344:	e8 37 f6 ff ff       	call   80104980 <argstr>
...
80105359:	e8 72 f5 ff ff       	call   801048d0 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010536e:	e8 5d f5 ff ff       	call   801048d0 <argint>
     argint(1, &major) < 0 ||
...
801053c5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801053c8:	e8 e3 e3 ff ff       	call   801037b0 <myproc>
...
801053dd:	e8 9e f5 ff ff       	call   80104980 <argstr>
...
80105485:	e8 f6 f4 ff ff       	call   80104980 <argstr>
...
801054a1:	e8 2a f4 ff ff       	call   801048d0 <argint>
...
801054c6:	e8 05 f1 ff ff       	call   801045d0 <memset>
...
801054e8:	e8 73 f3 ff ff       	call   80104860 <fetchstr>
...
80105510:	e8 0b f3 ff ff       	call   80104820 <fetchint>
...
80105571:	e8 aa f3 ff ff       	call   80104920 <argptr>
...
8010558c:	e8 9f dc ff ff       	call   80103230 <pipealloc>
...
8010559f:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801055a1:	e8 0a e2 ff ff       	call   801037b0 <myproc>
...
801055c7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801055ca:	e8 e1 e1 ff ff       	call   801037b0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105643:	5d                   	pop    %ebp
  return fork();
80105644:	e9 07 e3 ff ff       	jmp    80103950 <fork>
...
80105653:	83 ec 08             	sub    $0x8,%esp
  exit();
80105656:	e8 e5 e5 ff ff       	call   80103c40 <exit>
...
80105663:	5d                   	pop    %ebp
  return wait();
80105664:	e9 f7 e8 ff ff       	jmp    80103f60 <wait>
...
8010567c:	e8 4f f2 ff ff       	call   801048d0 <argint>
...
8010568e:	e8 2d ea ff ff       	call   801040c0 <kill>
...
801056b3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801056b6:	e8 f5 e0 ff ff       	call   801037b0 <myproc>
...
801056e6:	e8 e5 e1 ff ff       	call   801038d0 <growproc>
...
8010571d:	e8 ae f1 ff ff       	call   801048d0 <argint>
...
80105730:	68 60 53 11 80       	push   $0x80115360
80105735:	e8 86 ed ff ff       	call   801044c0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010573a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010573d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105740:	8b 1d a0 5b 11 80    	mov    0x80115ba0,%ebx
  while(ticks - ticks0 < n){
...
80105753:	68 60 53 11 80       	push   $0x80115360
80105758:	68 a0 5b 11 80       	push   $0x80115ba0
8010575d:	e8 3e e7 ff ff       	call   80103ea0 <sleep>
  while(ticks - ticks0 < n){
80105762:	a1 a0 5b 11 80       	mov    0x80115ba0,%eax
...
8010576f:	73 2f                	jae    801057a0 <sys_sleep+0x90>
    if(myproc()->killed){
80105771:	e8 3a e0 ff ff       	call   801037b0 <myproc>
...
80105780:	68 60 53 11 80       	push   $0x80115360
80105785:	e8 f6 ed ff ff       	call   80104580 <release>
      return -1;
...
801057a3:	68 60 53 11 80       	push   $0x80115360
801057a8:	e8 d3 ed ff ff       	call   80104580 <release>
  return 0;
...
801057c4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801057c7:	68 60 53 11 80       	push   $0x80115360
801057cc:	e8 ef ec ff ff       	call   801044c0 <acquire>
  xticks = ticks;
801057d1:	8b 1d a0 5b 11 80    	mov    0x80115ba0,%ebx
  release(&tickslock);
801057d7:	c7 04 24 60 53 11 80 	movl   $0x80115360,(%esp)
801057de:	e8 9d ed ff ff       	call   80104580 <release>
  return xticks;
}
...
801057fe:	e8 1d f1 ff ff       	call   80104920 <argptr>
	
	if (num==1)
80105803:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105806:	83 c4 10             	add    $0x10,%esp
80105809:	83 f8 01             	cmp    $0x1,%eax
8010580c:	74 52                	je     80105860 <sys_info+0x70>
	{
	x = procCount();
...
8010580e:	83 f8 02             	cmp    $0x2,%eax
80105811:	74 6d                	je     80105880 <sys_info+0x90>
	{
		cprintf("Count of the total number of system calls that the current process has made so far: %d\n", numcalls);
		
	}
	else if (num==3)
80105813:	83 f8 03             	cmp    $0x3,%eax
80105816:	74 18                	je     80105830 <sys_info+0x40>
...
8010581b:	68 dd 7b 10 80       	push   $0x80107bdd
80105820:	e8 3b ae ff ff       	call   80100660 <cprintf>
...
80105835:	8b 10                	mov    (%eax),%edx
		cprintf("Number of memory pages the current process is using: %d\n", mem1);
80105837:	83 ec 08             	sub    $0x8,%esp
		int mem1=memory/4096;
8010583a:	8d 82 ff 0f 00 00    	lea    0xfff(%edx),%eax
80105840:	85 d2                	test   %edx,%edx
80105842:	0f 49 c2             	cmovns %edx,%eax
80105845:	c1 f8 0c             	sar    $0xc,%eax
		cprintf("Number of memory pages the current process is using: %d\n", mem1);
80105848:	50                   	push   %eax
80105849:	68 a4 7b 10 80       	push   $0x80107ba4
8010584e:	e8 0d ae ff ff       	call   80100660 <cprintf>
...
8010585d:	8d 76 00             	lea    0x0(%esi),%esi
	x = procCount();
80105860:	e8 bb e9 ff ff       	call   80104220 <procCount>
	cprintf("Count of processes in the system: %d\n", x);
80105865:	83 ec 08             	sub    $0x8,%esp
80105868:	50                   	push   %eax
80105869:	68 24 7b 10 80       	push   $0x80107b24
8010586e:	e8 ed ad ff ff       	call   80100660 <cprintf>
...
80105883:	ff 35 bc a5 10 80    	pushl  0x8010a5bc
80105889:	68 4c 7b 10 80       	push   $0x80107b4c
...
801058ac:	e8 1f f0 ff ff       	call   801048d0 <argint>
801058b1:	83 c4 10             	add    $0x10,%esp
801058b4:	85 c0                	test   %eax,%eax
801058b6:	78 18                	js     801058d0 <sys_settickets+0x30>
  {
...
801058bd:	8b 55 f4             	mov    -0xc(%ebp),%edx
801058c0:	89 50 7c             	mov    %edx,0x7c(%eax)
  }
  return 0;
}
...
801058c9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
     myproc()->tickets = 10; 	//setting the default value
801058d0:	e8 db de ff ff       	call   801037b0 <myproc>
801058d5:	c7 40 7c 0a 00 00 00 	movl   $0xa,0x7c(%eax)
}
...
80105927:	c7 04 c5 a2 53 11 80 	movl   $0x8e000008,-0x7feeac5e(,%eax,8)
8010592e:	08 00 00 8e 
80105932:	66 89 14 c5 a0 53 11 	mov    %dx,-0x7feeac60(,%eax,8)
80105939:	80 
8010593a:	c1 ea 10             	shr    $0x10,%edx
8010593d:	66 89 14 c5 a6 53 11 	mov    %dx,-0x7feeac5a(,%eax,8)
80105944:	80 
  for(i = 0; i < 256; i++)
...
80105954:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105957:	c7 05 a2 55 11 80 08 	movl   $0xef000008,0x801155a2
8010595e:	00 00 ef 
  initlock(&tickslock, "time");
80105961:	68 f2 7b 10 80       	push   $0x80107bf2
80105966:	68 60 53 11 80       	push   $0x80115360
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010596b:	66 a3 a0 55 11 80    	mov    %ax,0x801155a0
80105971:	c1 e8 10             	shr    $0x10,%eax
80105974:	66 a3 a6 55 11 80    	mov    %ax,0x801155a6
  initlock(&tickslock, "time");
8010597a:	e8 01 ea ff ff       	call   80104380 <initlock>
}
...
8010599b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010599f:	b8 a0 53 11 80       	mov    $0x801153a0,%eax
...
801059e0:	ff 24 85 98 7c 10 80 	jmp    *-0x7fef8368(,%eax,4)
...
801059f0:	e8 bb dd ff ff       	call   801037b0 <myproc>
...
80105a10:	e8 7b dd ff ff       	call   80103790 <cpuid>
...
80105a29:	e8 82 dd ff ff       	call   801037b0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105a45:	68 54 7c 10 80       	push   $0x80107c54
...
80105a5e:	e8 4d dd ff ff       	call   801037b0 <myproc>
80105a63:	85 c0                	test   %eax,%eax
80105a65:	74 1d                	je     80105a84 <trap+0xc4>
80105a67:	e8 44 dd ff ff       	call   801037b0 <myproc>
80105a6c:	8b 50 24             	mov    0x24(%eax),%edx
...
80105a84:	e8 27 dd ff ff       	call   801037b0 <myproc>
80105a89:	85 c0                	test   %eax,%eax
80105a8b:	74 0b                	je     80105a98 <trap+0xd8>
80105a8d:	e8 1e dd ff ff       	call   801037b0 <myproc>
80105a92:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105a96:	74 68                	je     80105b00 <trap+0x140>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a98:	e8 13 dd ff ff       	call   801037b0 <myproc>
80105a9d:	85 c0                	test   %eax,%eax
80105a9f:	74 19                	je     80105aba <trap+0xfa>
80105aa1:	e8 0a dd ff ff       	call   801037b0 <myproc>
...
80105ac2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(myproc()->killed)
80105ac8:	e8 e3 dc ff ff       	call   801037b0 <myproc>
80105acd:	8b 58 24             	mov    0x24(%eax),%ebx
80105ad0:	85 db                	test   %ebx,%ebx
80105ad2:	0f 85 e8 00 00 00    	jne    80105bc0 <trap+0x200>
    myproc()->tf = tf;
80105ad8:	e8 d3 dc ff ff       	call   801037b0 <myproc>
80105add:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105ae0:	e8 db ee ff ff       	call   801049c0 <syscall>
    if(myproc()->killed)
80105ae5:	e8 c6 dc ff ff       	call   801037b0 <myproc>
80105aea:	8b 48 24             	mov    0x24(%eax),%ecx
...
80105b34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105b38:	e8 d3 ca ff ff       	call   80102610 <kbdintr>
    lapiceoi();
...
80105b5d:	e8 ee cb ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b62:	e8 49 dc ff ff       	call   801037b0 <myproc>
...
80105b7f:	e8 0c dc ff ff       	call   80103790 <cpuid>
80105b84:	56                   	push   %esi
80105b85:	53                   	push   %ebx
80105b86:	50                   	push   %eax
80105b87:	68 fc 7b 10 80       	push   $0x80107bfc
80105b8c:	e8 cf aa ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105b91:	e8 ba cb ff ff       	call   80102750 <lapiceoi>
    break;
80105b96:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b99:	e8 12 dc ff ff       	call   801037b0 <myproc>
...
80105bac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
80105bb0:	e8 cb c4 ff ff       	call   80102080 <ideintr>
80105bb5:	e9 63 ff ff ff       	jmp    80105b1d <trap+0x15d>
80105bba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105bc0:	e8 7b e0 ff ff       	call   80103c40 <exit>
80105bc5:	e9 0e ff ff ff       	jmp    80105ad8 <trap+0x118>
80105bca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105bd0:	e8 6b e0 ff ff       	call   80103c40 <exit>
80105bd5:	e9 aa fe ff ff       	jmp    80105a84 <trap+0xc4>
80105bda:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105be0:	83 ec 0c             	sub    $0xc,%esp
80105be3:	68 60 53 11 80       	push   $0x80115360
80105be8:	e8 d3 e8 ff ff       	call   801044c0 <acquire>
      wakeup(&ticks);
80105bed:	c7 04 24 a0 5b 11 80 	movl   $0x80115ba0,(%esp)
      ticks++;
80105bf4:	83 05 a0 5b 11 80 01 	addl   $0x1,0x80115ba0
      wakeup(&ticks);
80105bfb:	e8 60 e4 ff ff       	call   80104060 <wakeup>
      release(&tickslock);
80105c00:	c7 04 24 60 53 11 80 	movl   $0x80115360,(%esp)
80105c07:	e8 74 e9 ff ff       	call   80104580 <release>
...
80105c25:	68 20 7c 10 80       	push   $0x80107c20
80105c2a:	e8 31 aa ff ff       	call   80100660 <cprintf>
      panic("trap");
80105c2f:	83 c4 14             	add    $0x14,%esp
80105c32:	68 f7 7b 10 80       	push   $0x80107bf7
...
80105c95:	e8 d6 ca ff ff       	call   80102770 <microdelay>
...
80105d2c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105d2f:	bb 18 7d 10 80       	mov    $0x80107d18,%ebx
  ioapicenable(IRQ_COM1, 0);
80105d34:	6a 00                	push   $0x0
80105d36:	6a 04                	push   $0x4
80105d38:	e8 93 c5 ff ff       	call   801022d0 <ioapicenable>
...
80105dbb:	e8 50 aa ff ff       	call   80100810 <consoleintr>
}
...
80105dc7:	6a 00                	push   $0x0
  jmp alltraps
80105dc9:	e9 12 fb ff ff       	jmp    801058e0 <alltraps>
...
80105dd0:	6a 01                	push   $0x1
  jmp alltraps
80105dd2:	e9 09 fb ff ff       	jmp    801058e0 <alltraps>
...
80105dd9:	6a 02                	push   $0x2
  jmp alltraps
80105ddb:	e9 00 fb ff ff       	jmp    801058e0 <alltraps>
...
80105de2:	6a 03                	push   $0x3
  jmp alltraps
80105de4:	e9 f7 fa ff ff       	jmp    801058e0 <alltraps>
...
80105deb:	6a 04                	push   $0x4
  jmp alltraps
80105ded:	e9 ee fa ff ff       	jmp    801058e0 <alltraps>
...
80105df4:	6a 05                	push   $0x5
  jmp alltraps
80105df6:	e9 e5 fa ff ff       	jmp    801058e0 <alltraps>
...
80105dfd:	6a 06                	push   $0x6
  jmp alltraps
80105dff:	e9 dc fa ff ff       	jmp    801058e0 <alltraps>
...
80105e06:	6a 07                	push   $0x7
  jmp alltraps
80105e08:	e9 d3 fa ff ff       	jmp    801058e0 <alltraps>
...
80105e0d:	6a 08                	push   $0x8
  jmp alltraps
80105e0f:	e9 cc fa ff ff       	jmp    801058e0 <alltraps>
...
80105e16:	6a 09                	push   $0x9
  jmp alltraps
80105e18:	e9 c3 fa ff ff       	jmp    801058e0 <alltraps>
...
80105e1d:	6a 0a                	push   $0xa
  jmp alltraps
80105e1f:	e9 bc fa ff ff       	jmp    801058e0 <alltraps>
...
80105e24:	6a 0b                	push   $0xb
  jmp alltraps
80105e26:	e9 b5 fa ff ff       	jmp    801058e0 <alltraps>
...
80105e2b:	6a 0c                	push   $0xc
  jmp alltraps
80105e2d:	e9 ae fa ff ff       	jmp    801058e0 <alltraps>
...
80105e32:	6a 0d                	push   $0xd
  jmp alltraps
80105e34:	e9 a7 fa ff ff       	jmp    801058e0 <alltraps>
...
80105e39:	6a 0e                	push   $0xe
  jmp alltraps
80105e3b:	e9 a0 fa ff ff       	jmp    801058e0 <alltraps>
...
80105e42:	6a 0f                	push   $0xf
  jmp alltraps
80105e44:	e9 97 fa ff ff       	jmp    801058e0 <alltraps>
...
80105e4b:	6a 10                	push   $0x10
  jmp alltraps
80105e4d:	e9 8e fa ff ff       	jmp    801058e0 <alltraps>
...
80105e52:	6a 11                	push   $0x11
  jmp alltraps
80105e54:	e9 87 fa ff ff       	jmp    801058e0 <alltraps>
...
80105e5b:	6a 12                	push   $0x12
  jmp alltraps
80105e5d:	e9 7e fa ff ff       	jmp    801058e0 <alltraps>
...
80105e64:	6a 13                	push   $0x13
  jmp alltraps
80105e66:	e9 75 fa ff ff       	jmp    801058e0 <alltraps>
...
80105e6d:	6a 14                	push   $0x14
  jmp alltraps
80105e6f:	e9 6c fa ff ff       	jmp    801058e0 <alltraps>
...
80105e76:	6a 15                	push   $0x15
  jmp alltraps
80105e78:	e9 63 fa ff ff       	jmp    801058e0 <alltraps>
...
80105e7f:	6a 16                	push   $0x16
  jmp alltraps
80105e81:	e9 5a fa ff ff       	jmp    801058e0 <alltraps>
...
80105e88:	6a 17                	push   $0x17
  jmp alltraps
80105e8a:	e9 51 fa ff ff       	jmp    801058e0 <alltraps>
...
80105e91:	6a 18                	push   $0x18
  jmp alltraps
80105e93:	e9 48 fa ff ff       	jmp    801058e0 <alltraps>
...
80105e9a:	6a 19                	push   $0x19
  jmp alltraps
80105e9c:	e9 3f fa ff ff       	jmp    801058e0 <alltraps>
...
80105ea3:	6a 1a                	push   $0x1a
  jmp alltraps
80105ea5:	e9 36 fa ff ff       	jmp    801058e0 <alltraps>
...
80105eac:	6a 1b                	push   $0x1b
  jmp alltraps
80105eae:	e9 2d fa ff ff       	jmp    801058e0 <alltraps>
...
80105eb5:	6a 1c                	push   $0x1c
  jmp alltraps
80105eb7:	e9 24 fa ff ff       	jmp    801058e0 <alltraps>
...
80105ebe:	6a 1d                	push   $0x1d
  jmp alltraps
80105ec0:	e9 1b fa ff ff       	jmp    801058e0 <alltraps>
...
80105ec7:	6a 1e                	push   $0x1e
  jmp alltraps
80105ec9:	e9 12 fa ff ff       	jmp    801058e0 <alltraps>
...
80105ed0:	6a 1f                	push   $0x1f
  jmp alltraps
80105ed2:	e9 09 fa ff ff       	jmp    801058e0 <alltraps>
...
80105ed9:	6a 20                	push   $0x20
  jmp alltraps
80105edb:	e9 00 fa ff ff       	jmp    801058e0 <alltraps>
...
80105ee2:	6a 21                	push   $0x21
  jmp alltraps
80105ee4:	e9 f7 f9 ff ff       	jmp    801058e0 <alltraps>
...
80105eeb:	6a 22                	push   $0x22
  jmp alltraps
80105eed:	e9 ee f9 ff ff       	jmp    801058e0 <alltraps>
...
80105ef4:	6a 23                	push   $0x23
  jmp alltraps
80105ef6:	e9 e5 f9 ff ff       	jmp    801058e0 <alltraps>
...
80105f06:	6a 25                	push   $0x25
  jmp alltraps
80105f08:	e9 d3 f9 ff ff       	jmp    801058e0 <alltraps>
...
80105f0f:	6a 26                	push   $0x26
  jmp alltraps
80105f11:	e9 ca f9 ff ff       	jmp    801058e0 <alltraps>
...
80105f18:	6a 27                	push   $0x27
  jmp alltraps
80105f1a:	e9 c1 f9 ff ff       	jmp    801058e0 <alltraps>
...
80105f21:	6a 28                	push   $0x28
  jmp alltraps
80105f23:	e9 b8 f9 ff ff       	jmp    801058e0 <alltraps>
...
80105f2a:	6a 29                	push   $0x29
  jmp alltraps
80105f2c:	e9 af f9 ff ff       	jmp    801058e0 <alltraps>
...
80105f33:	6a 2a                	push   $0x2a
  jmp alltraps
80105f35:	e9 a6 f9 ff ff       	jmp    801058e0 <alltraps>
...
80105f3c:	6a 2b                	push   $0x2b
  jmp alltraps
80105f3e:	e9 9d f9 ff ff       	jmp    801058e0 <alltraps>
...
80105f45:	6a 2c                	push   $0x2c
  jmp alltraps
80105f47:	e9 94 f9 ff ff       	jmp    801058e0 <alltraps>
...
80105f4e:	6a 2d                	push   $0x2d
  jmp alltraps
80105f50:	e9 8b f9 ff ff       	jmp    801058e0 <alltraps>
...
80105f57:	6a 2e                	push   $0x2e
  jmp alltraps
80105f59:	e9 82 f9 ff ff       	jmp    801058e0 <alltraps>
...
80105f60:	6a 2f                	push   $0x2f
  jmp alltraps
80105f62:	e9 79 f9 ff ff       	jmp    801058e0 <alltraps>
...
80105f69:	6a 30                	push   $0x30
  jmp alltraps
80105f6b:	e9 70 f9 ff ff       	jmp    801058e0 <alltraps>
...
80105f72:	6a 31                	push   $0x31
  jmp alltraps
80105f74:	e9 67 f9 ff ff       	jmp    801058e0 <alltraps>
...
80105f7b:	6a 32                	push   $0x32
  jmp alltraps
80105f7d:	e9 5e f9 ff ff       	jmp    801058e0 <alltraps>
...
80105f84:	6a 33                	push   $0x33
  jmp alltraps
80105f86:	e9 55 f9 ff ff       	jmp    801058e0 <alltraps>
...
80105f8d:	6a 34                	push   $0x34
  jmp alltraps
80105f8f:	e9 4c f9 ff ff       	jmp    801058e0 <alltraps>
...
80105f96:	6a 35                	push   $0x35
  jmp alltraps
80105f98:	e9 43 f9 ff ff       	jmp    801058e0 <alltraps>
...
80105f9f:	6a 36                	push   $0x36
  jmp alltraps
80105fa1:	e9 3a f9 ff ff       	jmp    801058e0 <alltraps>
...
80105fa8:	6a 37                	push   $0x37
  jmp alltraps
80105faa:	e9 31 f9 ff ff       	jmp    801058e0 <alltraps>
...
80105fb1:	6a 38                	push   $0x38
  jmp alltraps
80105fb3:	e9 28 f9 ff ff       	jmp    801058e0 <alltraps>
...
80105fba:	6a 39                	push   $0x39
  jmp alltraps
80105fbc:	e9 1f f9 ff ff       	jmp    801058e0 <alltraps>
...
80105fc3:	6a 3a                	push   $0x3a
  jmp alltraps
80105fc5:	e9 16 f9 ff ff       	jmp    801058e0 <alltraps>
...
80105fcc:	6a 3b                	push   $0x3b
  jmp alltraps
80105fce:	e9 0d f9 ff ff       	jmp    801058e0 <alltraps>
...
80105fd5:	6a 3c                	push   $0x3c
  jmp alltraps
80105fd7:	e9 04 f9 ff ff       	jmp    801058e0 <alltraps>
...
80105fde:	6a 3d                	push   $0x3d
  jmp alltraps
80105fe0:	e9 fb f8 ff ff       	jmp    801058e0 <alltraps>
...
80105fe7:	6a 3e                	push   $0x3e
  jmp alltraps
80105fe9:	e9 f2 f8 ff ff       	jmp    801058e0 <alltraps>
...
80105ff0:	6a 3f                	push   $0x3f
  jmp alltraps
80105ff2:	e9 e9 f8 ff ff       	jmp    801058e0 <alltraps>
...
80105ff9:	6a 40                	push   $0x40
  jmp alltraps
80105ffb:	e9 e0 f8 ff ff       	jmp    801058e0 <alltraps>
...
80106002:	6a 41                	push   $0x41
  jmp alltraps
80106004:	e9 d7 f8 ff ff       	jmp    801058e0 <alltraps>
...
8010600b:	6a 42                	push   $0x42
  jmp alltraps
8010600d:	e9 ce f8 ff ff       	jmp    801058e0 <alltraps>
...
80106014:	6a 43                	push   $0x43
  jmp alltraps
80106016:	e9 c5 f8 ff ff       	jmp    801058e0 <alltraps>
...
8010601d:	6a 44                	push   $0x44
  jmp alltraps
8010601f:	e9 bc f8 ff ff       	jmp    801058e0 <alltraps>
...
80106026:	6a 45                	push   $0x45
  jmp alltraps
80106028:	e9 b3 f8 ff ff       	jmp    801058e0 <alltraps>
...
8010602f:	6a 46                	push   $0x46
  jmp alltraps
80106031:	e9 aa f8 ff ff       	jmp    801058e0 <alltraps>
...
80106038:	6a 47                	push   $0x47
  jmp alltraps
8010603a:	e9 a1 f8 ff ff       	jmp    801058e0 <alltraps>
...
80106041:	6a 48                	push   $0x48
  jmp alltraps
80106043:	e9 98 f8 ff ff       	jmp    801058e0 <alltraps>
...
8010604a:	6a 49                	push   $0x49
  jmp alltraps
8010604c:	e9 8f f8 ff ff       	jmp    801058e0 <alltraps>
...
80106053:	6a 4a                	push   $0x4a
  jmp alltraps
80106055:	e9 86 f8 ff ff       	jmp    801058e0 <alltraps>
...
8010605c:	6a 4b                	push   $0x4b
  jmp alltraps
8010605e:	e9 7d f8 ff ff       	jmp    801058e0 <alltraps>
...
80106065:	6a 4c                	push   $0x4c
  jmp alltraps
80106067:	e9 74 f8 ff ff       	jmp    801058e0 <alltraps>
...
8010606e:	6a 4d                	push   $0x4d
  jmp alltraps
80106070:	e9 6b f8 ff ff       	jmp    801058e0 <alltraps>
...
80106077:	6a 4e                	push   $0x4e
  jmp alltraps
80106079:	e9 62 f8 ff ff       	jmp    801058e0 <alltraps>
...
80106080:	6a 4f                	push   $0x4f
  jmp alltraps
80106082:	e9 59 f8 ff ff       	jmp    801058e0 <alltraps>
...
80106089:	6a 50                	push   $0x50
  jmp alltraps
8010608b:	e9 50 f8 ff ff       	jmp    801058e0 <alltraps>
...
80106092:	6a 51                	push   $0x51
  jmp alltraps
80106094:	e9 47 f8 ff ff       	jmp    801058e0 <alltraps>
...
8010609b:	6a 52                	push   $0x52
  jmp alltraps
8010609d:	e9 3e f8 ff ff       	jmp    801058e0 <alltraps>
...
801060a4:	6a 53                	push   $0x53
  jmp alltraps
801060a6:	e9 35 f8 ff ff       	jmp    801058e0 <alltraps>
...
801060ad:	6a 54                	push   $0x54
  jmp alltraps
801060af:	e9 2c f8 ff ff       	jmp    801058e0 <alltraps>
...
801060b6:	6a 55                	push   $0x55
  jmp alltraps
801060b8:	e9 23 f8 ff ff       	jmp    801058e0 <alltraps>
...
801060bf:	6a 56                	push   $0x56
  jmp alltraps
801060c1:	e9 1a f8 ff ff       	jmp    801058e0 <alltraps>
...
801060c8:	6a 57                	push   $0x57
  jmp alltraps
801060ca:	e9 11 f8 ff ff       	jmp    801058e0 <alltraps>
...
801060d1:	6a 58                	push   $0x58
  jmp alltraps
801060d3:	e9 08 f8 ff ff       	jmp    801058e0 <alltraps>
...
801060da:	6a 59                	push   $0x59
  jmp alltraps
801060dc:	e9 ff f7 ff ff       	jmp    801058e0 <alltraps>
...
801060e3:	6a 5a                	push   $0x5a
  jmp alltraps
801060e5:	e9 f6 f7 ff ff       	jmp    801058e0 <alltraps>
...
801060ec:	6a 5b                	push   $0x5b
  jmp alltraps
801060ee:	e9 ed f7 ff ff       	jmp    801058e0 <alltraps>
...
801060f5:	6a 5c                	push   $0x5c
  jmp alltraps
801060f7:	e9 e4 f7 ff ff       	jmp    801058e0 <alltraps>
...
801060fe:	6a 5d                	push   $0x5d
  jmp alltraps
80106100:	e9 db f7 ff ff       	jmp    801058e0 <alltraps>
...
80106107:	6a 5e                	push   $0x5e
  jmp alltraps
80106109:	e9 d2 f7 ff ff       	jmp    801058e0 <alltraps>
...
80106110:	6a 5f                	push   $0x5f
  jmp alltraps
80106112:	e9 c9 f7 ff ff       	jmp    801058e0 <alltraps>
...
80106119:	6a 60                	push   $0x60
  jmp alltraps
8010611b:	e9 c0 f7 ff ff       	jmp    801058e0 <alltraps>
...
80106122:	6a 61                	push   $0x61
  jmp alltraps
80106124:	e9 b7 f7 ff ff       	jmp    801058e0 <alltraps>
...
8010612b:	6a 62                	push   $0x62
  jmp alltraps
8010612d:	e9 ae f7 ff ff       	jmp    801058e0 <alltraps>
...
80106134:	6a 63                	push   $0x63
  jmp alltraps
80106136:	e9 a5 f7 ff ff       	jmp    801058e0 <alltraps>
...
8010613d:	6a 64                	push   $0x64
  jmp alltraps
8010613f:	e9 9c f7 ff ff       	jmp    801058e0 <alltraps>
...
80106146:	6a 65                	push   $0x65
  jmp alltraps
80106148:	e9 93 f7 ff ff       	jmp    801058e0 <alltraps>
...
8010614f:	6a 66                	push   $0x66
  jmp alltraps
80106151:	e9 8a f7 ff ff       	jmp    801058e0 <alltraps>
...
80106158:	6a 67                	push   $0x67
  jmp alltraps
8010615a:	e9 81 f7 ff ff       	jmp    801058e0 <alltraps>
...
80106161:	6a 68                	push   $0x68
  jmp alltraps
80106163:	e9 78 f7 ff ff       	jmp    801058e0 <alltraps>
...
8010616a:	6a 69                	push   $0x69
  jmp alltraps
8010616c:	e9 6f f7 ff ff       	jmp    801058e0 <alltraps>
...
80106173:	6a 6a                	push   $0x6a
  jmp alltraps
80106175:	e9 66 f7 ff ff       	jmp    801058e0 <alltraps>
...
8010617c:	6a 6b                	push   $0x6b
  jmp alltraps
8010617e:	e9 5d f7 ff ff       	jmp    801058e0 <alltraps>
...
80106185:	6a 6c                	push   $0x6c
  jmp alltraps
80106187:	e9 54 f7 ff ff       	jmp    801058e0 <alltraps>
...
8010618e:	6a 6d                	push   $0x6d
  jmp alltraps
80106190:	e9 4b f7 ff ff       	jmp    801058e0 <alltraps>
...
80106197:	6a 6e                	push   $0x6e
  jmp alltraps
80106199:	e9 42 f7 ff ff       	jmp    801058e0 <alltraps>
...
801061a0:	6a 6f                	push   $0x6f
  jmp alltraps
801061a2:	e9 39 f7 ff ff       	jmp    801058e0 <alltraps>
...
801061a9:	6a 70                	push   $0x70
  jmp alltraps
801061ab:	e9 30 f7 ff ff       	jmp    801058e0 <alltraps>
...
801061b2:	6a 71                	push   $0x71
  jmp alltraps
801061b4:	e9 27 f7 ff ff       	jmp    801058e0 <alltraps>
...
801061bb:	6a 72                	push   $0x72
  jmp alltraps
801061bd:	e9 1e f7 ff ff       	jmp    801058e0 <alltraps>
...
801061c4:	6a 73                	push   $0x73
  jmp alltraps
801061c6:	e9 15 f7 ff ff       	jmp    801058e0 <alltraps>
...
801061cd:	6a 74                	push   $0x74
  jmp alltraps
801061cf:	e9 0c f7 ff ff       	jmp    801058e0 <alltraps>
...
801061d6:	6a 75                	push   $0x75
  jmp alltraps
801061d8:	e9 03 f7 ff ff       	jmp    801058e0 <alltraps>
...
801061df:	6a 76                	push   $0x76
  jmp alltraps
801061e1:	e9 fa f6 ff ff       	jmp    801058e0 <alltraps>
...
801061e8:	6a 77                	push   $0x77
  jmp alltraps
801061ea:	e9 f1 f6 ff ff       	jmp    801058e0 <alltraps>
...
801061f1:	6a 78                	push   $0x78
  jmp alltraps
801061f3:	e9 e8 f6 ff ff       	jmp    801058e0 <alltraps>
...
801061fa:	6a 79                	push   $0x79
  jmp alltraps
801061fc:	e9 df f6 ff ff       	jmp    801058e0 <alltraps>
...
80106203:	6a 7a                	push   $0x7a
  jmp alltraps
80106205:	e9 d6 f6 ff ff       	jmp    801058e0 <alltraps>
...
8010620c:	6a 7b                	push   $0x7b
  jmp alltraps
8010620e:	e9 cd f6 ff ff       	jmp    801058e0 <alltraps>
...
80106215:	6a 7c                	push   $0x7c
  jmp alltraps
80106217:	e9 c4 f6 ff ff       	jmp    801058e0 <alltraps>
...
8010621e:	6a 7d                	push   $0x7d
  jmp alltraps
80106220:	e9 bb f6 ff ff       	jmp    801058e0 <alltraps>
...
80106227:	6a 7e                	push   $0x7e
  jmp alltraps
80106229:	e9 b2 f6 ff ff       	jmp    801058e0 <alltraps>
...
80106230:	6a 7f                	push   $0x7f
  jmp alltraps
80106232:	e9 a9 f6 ff ff       	jmp    801058e0 <alltraps>
...
80106239:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010623e:	e9 9d f6 ff ff       	jmp    801058e0 <alltraps>
...
80106245:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010624a:	e9 91 f6 ff ff       	jmp    801058e0 <alltraps>
...
80106251:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106256:	e9 85 f6 ff ff       	jmp    801058e0 <alltraps>
...
8010625d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106262:	e9 79 f6 ff ff       	jmp    801058e0 <alltraps>
...
80106269:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010626e:	e9 6d f6 ff ff       	jmp    801058e0 <alltraps>
...
80106275:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010627a:	e9 61 f6 ff ff       	jmp    801058e0 <alltraps>
...
80106281:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106286:	e9 55 f6 ff ff       	jmp    801058e0 <alltraps>
...
8010628d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106292:	e9 49 f6 ff ff       	jmp    801058e0 <alltraps>
...
80106299:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010629e:	e9 3d f6 ff ff       	jmp    801058e0 <alltraps>
...
801062a5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801062aa:	e9 31 f6 ff ff       	jmp    801058e0 <alltraps>
...
801062b1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801062b6:	e9 25 f6 ff ff       	jmp    801058e0 <alltraps>
...
801062bd:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801062c2:	e9 19 f6 ff ff       	jmp    801058e0 <alltraps>
...
801062c9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801062ce:	e9 0d f6 ff ff       	jmp    801058e0 <alltraps>
...
801062d5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801062da:	e9 01 f6 ff ff       	jmp    801058e0 <alltraps>
...
801062e1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801062e6:	e9 f5 f5 ff ff       	jmp    801058e0 <alltraps>
...
801062ed:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801062f2:	e9 e9 f5 ff ff       	jmp    801058e0 <alltraps>
...
801062f9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801062fe:	e9 dd f5 ff ff       	jmp    801058e0 <alltraps>
...
80106305:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010630a:	e9 d1 f5 ff ff       	jmp    801058e0 <alltraps>
...
80106311:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106316:	e9 c5 f5 ff ff       	jmp    801058e0 <alltraps>
...
8010631d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106322:	e9 b9 f5 ff ff       	jmp    801058e0 <alltraps>
...
80106329:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010632e:	e9 ad f5 ff ff       	jmp    801058e0 <alltraps>
...
80106335:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010633a:	e9 a1 f5 ff ff       	jmp    801058e0 <alltraps>
...
80106341:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106346:	e9 95 f5 ff ff       	jmp    801058e0 <alltraps>
...
8010634d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106352:	e9 89 f5 ff ff       	jmp    801058e0 <alltraps>
...
80106359:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010635e:	e9 7d f5 ff ff       	jmp    801058e0 <alltraps>
...
80106365:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010636a:	e9 71 f5 ff ff       	jmp    801058e0 <alltraps>
...
80106371:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106376:	e9 65 f5 ff ff       	jmp    801058e0 <alltraps>
...
8010637d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106382:	e9 59 f5 ff ff       	jmp    801058e0 <alltraps>
...
80106389:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010638e:	e9 4d f5 ff ff       	jmp    801058e0 <alltraps>
...
80106395:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010639a:	e9 41 f5 ff ff       	jmp    801058e0 <alltraps>
...
801063a1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801063a6:	e9 35 f5 ff ff       	jmp    801058e0 <alltraps>
...
801063ad:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801063b2:	e9 29 f5 ff ff       	jmp    801058e0 <alltraps>
...
801063b9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801063be:	e9 1d f5 ff ff       	jmp    801058e0 <alltraps>
...
801063c5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801063ca:	e9 11 f5 ff ff       	jmp    801058e0 <alltraps>
...
801063d1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801063d6:	e9 05 f5 ff ff       	jmp    801058e0 <alltraps>
...
801063dd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801063e2:	e9 f9 f4 ff ff       	jmp    801058e0 <alltraps>
...
801063e9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801063ee:	e9 ed f4 ff ff       	jmp    801058e0 <alltraps>
...
801063f5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801063fa:	e9 e1 f4 ff ff       	jmp    801058e0 <alltraps>
...
80106401:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106406:	e9 d5 f4 ff ff       	jmp    801058e0 <alltraps>
...
8010640d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106412:	e9 c9 f4 ff ff       	jmp    801058e0 <alltraps>
...
80106419:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010641e:	e9 bd f4 ff ff       	jmp    801058e0 <alltraps>
...
80106425:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010642a:	e9 b1 f4 ff ff       	jmp    801058e0 <alltraps>
...
80106431:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106436:	e9 a5 f4 ff ff       	jmp    801058e0 <alltraps>
...
8010643d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106442:	e9 99 f4 ff ff       	jmp    801058e0 <alltraps>
...
80106449:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010644e:	e9 8d f4 ff ff       	jmp    801058e0 <alltraps>
...
80106455:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010645a:	e9 81 f4 ff ff       	jmp    801058e0 <alltraps>
...
80106461:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106466:	e9 75 f4 ff ff       	jmp    801058e0 <alltraps>
...
8010646d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106472:	e9 69 f4 ff ff       	jmp    801058e0 <alltraps>
...
80106479:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010647e:	e9 5d f4 ff ff       	jmp    801058e0 <alltraps>
...
80106485:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010648a:	e9 51 f4 ff ff       	jmp    801058e0 <alltraps>
...
80106491:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106496:	e9 45 f4 ff ff       	jmp    801058e0 <alltraps>
...
8010649d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801064a2:	e9 39 f4 ff ff       	jmp    801058e0 <alltraps>
...
801064a9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801064ae:	e9 2d f4 ff ff       	jmp    801058e0 <alltraps>
...
801064b5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801064ba:	e9 21 f4 ff ff       	jmp    801058e0 <alltraps>
...
801064c1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801064c6:	e9 15 f4 ff ff       	jmp    801058e0 <alltraps>
...
801064cd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801064d2:	e9 09 f4 ff ff       	jmp    801058e0 <alltraps>
...
801064d9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801064de:	e9 fd f3 ff ff       	jmp    801058e0 <alltraps>
...
801064e5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801064ea:	e9 f1 f3 ff ff       	jmp    801058e0 <alltraps>
...
801064f1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801064f6:	e9 e5 f3 ff ff       	jmp    801058e0 <alltraps>
...
801064fd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106502:	e9 d9 f3 ff ff       	jmp    801058e0 <alltraps>
...
80106509:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010650e:	e9 cd f3 ff ff       	jmp    801058e0 <alltraps>
...
80106515:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010651a:	e9 c1 f3 ff ff       	jmp    801058e0 <alltraps>
...
80106521:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106526:	e9 b5 f3 ff ff       	jmp    801058e0 <alltraps>
...
8010652d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106532:	e9 a9 f3 ff ff       	jmp    801058e0 <alltraps>
...
80106539:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010653e:	e9 9d f3 ff ff       	jmp    801058e0 <alltraps>
...
80106545:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010654a:	e9 91 f3 ff ff       	jmp    801058e0 <alltraps>
...
80106551:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106556:	e9 85 f3 ff ff       	jmp    801058e0 <alltraps>
...
8010655d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106562:	e9 79 f3 ff ff       	jmp    801058e0 <alltraps>
...
80106569:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010656e:	e9 6d f3 ff ff       	jmp    801058e0 <alltraps>
...
80106575:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010657a:	e9 61 f3 ff ff       	jmp    801058e0 <alltraps>
...
80106581:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106586:	e9 55 f3 ff ff       	jmp    801058e0 <alltraps>
...
8010658d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106592:	e9 49 f3 ff ff       	jmp    801058e0 <alltraps>
...
80106599:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010659e:	e9 3d f3 ff ff       	jmp    801058e0 <alltraps>
...
801065a5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801065aa:	e9 31 f3 ff ff       	jmp    801058e0 <alltraps>
...
801065b1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801065b6:	e9 25 f3 ff ff       	jmp    801058e0 <alltraps>
...
801065bd:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801065c2:	e9 19 f3 ff ff       	jmp    801058e0 <alltraps>
...
801065c9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801065ce:	e9 0d f3 ff ff       	jmp    801058e0 <alltraps>
...
801065d5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801065da:	e9 01 f3 ff ff       	jmp    801058e0 <alltraps>
...
801065e1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801065e6:	e9 f5 f2 ff ff       	jmp    801058e0 <alltraps>
...
801065ed:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801065f2:	e9 e9 f2 ff ff       	jmp    801058e0 <alltraps>
...
801065f9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801065fe:	e9 dd f2 ff ff       	jmp    801058e0 <alltraps>
...
80106605:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010660a:	e9 d1 f2 ff ff       	jmp    801058e0 <alltraps>
...
80106611:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106616:	e9 c5 f2 ff ff       	jmp    801058e0 <alltraps>
...
8010661d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106622:	e9 b9 f2 ff ff       	jmp    801058e0 <alltraps>
...
80106629:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010662e:	e9 ad f2 ff ff       	jmp    801058e0 <alltraps>
...
80106635:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010663a:	e9 a1 f2 ff ff       	jmp    801058e0 <alltraps>
...
80106641:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106646:	e9 95 f2 ff ff       	jmp    801058e0 <alltraps>
...
8010664d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106652:	e9 89 f2 ff ff       	jmp    801058e0 <alltraps>
...
80106659:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010665e:	e9 7d f2 ff ff       	jmp    801058e0 <alltraps>
...
80106665:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010666a:	e9 71 f2 ff ff       	jmp    801058e0 <alltraps>
...
80106671:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106676:	e9 65 f2 ff ff       	jmp    801058e0 <alltraps>
...
8010667d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106682:	e9 59 f2 ff ff       	jmp    801058e0 <alltraps>
...
80106689:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010668e:	e9 4d f2 ff ff       	jmp    801058e0 <alltraps>
...
80106695:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010669a:	e9 41 f2 ff ff       	jmp    801058e0 <alltraps>
...
801066a1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801066a6:	e9 35 f2 ff ff       	jmp    801058e0 <alltraps>
...
801066ad:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801066b2:	e9 29 f2 ff ff       	jmp    801058e0 <alltraps>
...
801066b9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801066be:	e9 1d f2 ff ff       	jmp    801058e0 <alltraps>
...
801066c5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801066ca:	e9 11 f2 ff ff       	jmp    801058e0 <alltraps>
...
801066d1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801066d6:	e9 05 f2 ff ff       	jmp    801058e0 <alltraps>
...
801066dd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801066e2:	e9 f9 f1 ff ff       	jmp    801058e0 <alltraps>
...
801066e9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801066ee:	e9 ed f1 ff ff       	jmp    801058e0 <alltraps>
...
801066f5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801066fa:	e9 e1 f1 ff ff       	jmp    801058e0 <alltraps>
...
80106701:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106706:	e9 d5 f1 ff ff       	jmp    801058e0 <alltraps>
...
8010670d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106712:	e9 c9 f1 ff ff       	jmp    801058e0 <alltraps>
...
80106719:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010671e:	e9 bd f1 ff ff       	jmp    801058e0 <alltraps>
...
80106725:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010672a:	e9 b1 f1 ff ff       	jmp    801058e0 <alltraps>
...
80106731:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106736:	e9 a5 f1 ff ff       	jmp    801058e0 <alltraps>
...
8010673d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106742:	e9 99 f1 ff ff       	jmp    801058e0 <alltraps>
...
80106749:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010674e:	e9 8d f1 ff ff       	jmp    801058e0 <alltraps>
...
80106755:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010675a:	e9 81 f1 ff ff       	jmp    801058e0 <alltraps>
...
80106761:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106766:	e9 75 f1 ff ff       	jmp    801058e0 <alltraps>
...
8010676d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106772:	e9 69 f1 ff ff       	jmp    801058e0 <alltraps>
...
80106779:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010677e:	e9 5d f1 ff ff       	jmp    801058e0 <alltraps>
...
80106785:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010678a:	e9 51 f1 ff ff       	jmp    801058e0 <alltraps>
...
80106791:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106796:	e9 45 f1 ff ff       	jmp    801058e0 <alltraps>
...
8010679d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801067a2:	e9 39 f1 ff ff       	jmp    801058e0 <alltraps>
...
801067a9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801067ae:	e9 2d f1 ff ff       	jmp    801058e0 <alltraps>
...
801067b5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801067ba:	e9 21 f1 ff ff       	jmp    801058e0 <alltraps>
...
801067c1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801067c6:	e9 15 f1 ff ff       	jmp    801058e0 <alltraps>
...
801067cd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801067d2:	e9 09 f1 ff ff       	jmp    801058e0 <alltraps>
...
801067d9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801067de:	e9 fd f0 ff ff       	jmp    801058e0 <alltraps>
...
801067e5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801067ea:	e9 f1 f0 ff ff       	jmp    801058e0 <alltraps>
...
801067f1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801067f6:	e9 e5 f0 ff ff       	jmp    801058e0 <alltraps>
...
801067fd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106802:	e9 d9 f0 ff ff       	jmp    801058e0 <alltraps>
...
80106809:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010680e:	e9 cd f0 ff ff       	jmp    801058e0 <alltraps>
...
80106815:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010681a:	e9 c1 f0 ff ff       	jmp    801058e0 <alltraps>
...
80106821:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106826:	e9 b5 f0 ff ff       	jmp    801058e0 <alltraps>
...
8010682d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106832:	e9 a9 f0 ff ff       	jmp    801058e0 <alltraps>
...
80106884:	e8 37 bc ff ff       	call   801024c0 <kalloc>
...
8010689a:	e8 31 dd ff ff       	call   801045d0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010693d:	68 20 7d 10 80       	push   $0x80107d20
...
80106994:	e8 77 b9 ff ff       	call   80102310 <kfree>
      *pte = 0;
...
801069e2:	68 a6 75 10 80       	push   $0x801075a6
...
801069f3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801069f6:	e8 95 cd ff ff       	call   80103790 <cpuid>
...
80106a80:	a1 a4 5b 11 80       	mov    0x80115ba4,%eax
{
...
80106ac4:	0f 84 c2 00 00 00    	je     80106b8c <switchuvm+0xec>
  pushcli();
80106aca:	e8 21 d9 ff ff       	call   801043f0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106acf:	e8 6c cc ff ff       	call   80103740 <mycpu>
80106ad4:	89 c6                	mov    %eax,%esi
80106ad6:	e8 65 cc ff ff       	call   80103740 <mycpu>
...
80106ae8:	e8 53 cc ff ff       	call   80103740 <mycpu>
...
80106b31:	e8 0a cc ff ff       	call   80103740 <mycpu>
...
80106b49:	e8 f2 cb ff ff       	call   80103740 <mycpu>
80106b4e:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106b54:	89 70 0c             	mov    %esi,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106b57:	e8 e4 cb ff ff       	call   80103740 <mycpu>
...
80106bcb:	77 49                	ja     80106c16 <inituvm+0x66>
  mem = kalloc();
80106bcd:	e8 ee b8 ff ff       	call   801024c0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106bdf:	e8 ec d9 ff ff       	call   801045d0 <memset>
...
80106c10:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c11:	e9 6a da ff ff       	jmp    80104680 <memmove>
    panic("inituvm: more than a page");
80106c16:	83 ec 0c             	sub    $0xc,%esp
80106c19:	68 65 7d 10 80       	push   $0x80107d65
...
80106ca1:	e8 ba ac ff ff       	call   80101960 <readi>
...
80106d3b:	e8 90 d8 ff ff       	call   801045d0 <memset>
...
80106d69:	0f 86 81 00 00 00    	jbe    80106df0 <allocuvm+0x100>
    mem = kalloc();
80106d6f:	e8 4c b7 ff ff       	call   801024c0 <kalloc>
    if(mem == 0){
...
80106d7d:	68 9d 7d 10 80       	push   $0x80107d9d
...
80106db3:	68 b5 7d 10 80       	push   $0x80107db5
...
80106ddb:	e8 30 b5 ff ff       	call   80102310 <kfree>
      return 0;
...
80106e9e:	e8 6d b4 ff ff       	call   80102310 <kfree>
...
80106eb3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106eb4:	e9 57 b4 ff ff       	jmp    80102310 <kfree>
    panic("freevm: no pgdir");
80106eb9:	83 ec 0c             	sub    $0xc,%esp
80106ebc:	68 d1 7d 10 80       	push   $0x80107dd1
...
80106ed5:	e8 e6 b5 ff ff       	call   801024c0 <kalloc>
...
80106ef0:	e8 db d6 ff ff       	call   801045d0 <memset>
...
80106f5b:	a3 a4 5b 11 80       	mov    %eax,0x80115ba4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106f8f:	68 e2 7d 10 80       	push   $0x80107de2
...
80106fbe:	0f 84 94 00 00 00    	je     80107058 <copyuvm+0xb8>
80106fc4:	31 ff                	xor    %edi,%edi
80106fc6:	eb 4a                	jmp    80107012 <copyuvm+0x72>
80106fc8:	90                   	nop
...
80106fe0:	e8 9b d6 ff ff       	call   80104680 <memmove>
...
80107035:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80107038:	e8 83 b4 ff ff       	call   801024c0 <kalloc>
...
8010710f:	e8 6c d5 ff ff       	call   80104680 <memmove>
    len -= n;
    buf += n;
...
80107160:	5d                   	pop    %ebp
80107161:	c3                   	ret    
80107162:	66 90                	xchg   %ax,%ax
80107164:	66 90                	xchg   %ax,%ax
80107166:	66 90                	xchg   %ax,%ax
80107168:	66 90                	xchg   %ax,%ax
8010716a:	66 90                	xchg   %ax,%ax
...
80107171:	b8 e4 a5 10 80       	mov    $0x8010a5e4,%eax
80107176:	b9 9c af 10 80       	mov    $0x8010af9c,%ecx
8010717b:	89 e5                	mov    %esp,%ebp
8010717d:	8b 55 08             	mov    0x8(%ebp),%edx
    /* setting initial seeds to mt[N] using         */
    /* the generator Line 25 of Table 1 in          */
    /* [KNUTH 1981, The Art of Computer Programming */
    /*    Vol. 2 (2nd Ed.), pp102]                  */
    mt[0]= seed & 0xffffffff;
80107180:	89 15 e0 a5 10 80    	mov    %edx,0x8010a5e0
80107186:	eb 0b                	jmp    80107193 <sgenrand+0x23>
80107188:	90                   	nop
80107189:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80107190:	83 c0 04             	add    $0x4,%eax
    for (mti=1; mti<N; mti++)
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
80107193:	69 d2 cd 0d 01 00    	imul   $0x10dcd,%edx,%edx
    for (mti=1; mti<N; mti++)
80107199:	39 c1                	cmp    %eax,%ecx
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
8010719b:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
8010719d:	75 f1                	jne    80107190 <sgenrand+0x20>
8010719f:	c7 05 60 a4 10 80 70 	movl   $0x270,0x8010a460
801071a6:	02 00 00 
}
801071a9:	5d                   	pop    %ebp
801071aa:	c3                   	ret    
...
801071b0:	a1 60 a4 10 80       	mov    0x8010a460,%eax
{
...
801071b9:	53                   	push   %ebx
    if (mti >= N) { /* generate N words at one time */
801071ba:	3d 6f 02 00 00       	cmp    $0x26f,%eax
801071bf:	0f 8e f9 00 00 00    	jle    801072be <genrand+0x10e>
        int kk;

        if (mti == N+1)   /* if sgenrand() has not been called, */
801071c5:	3d 71 02 00 00       	cmp    $0x271,%eax
801071ca:	0f 84 fa 00 00 00    	je     801072ca <genrand+0x11a>
801071d0:	ba e0 a5 10 80       	mov    $0x8010a5e0,%edx
801071d5:	bb 6c a9 10 80       	mov    $0x8010a96c,%ebx
    mt[0]= seed & 0xffffffff;
801071da:	89 d1                	mov    %edx,%ecx
801071dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
            sgenrand(4357); /* a default initial seed is used   */

        for (kk=0;kk<N-M;kk++) {
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
801071e0:	8b 01                	mov    (%ecx),%eax
801071e2:	8b 71 04             	mov    0x4(%ecx),%esi
801071e5:	83 c1 04             	add    $0x4,%ecx
801071e8:	81 e6 ff ff ff 7f    	and    $0x7fffffff,%esi
801071ee:	25 00 00 00 80       	and    $0x80000000,%eax
801071f3:	09 f0                	or     %esi,%eax
            mt[kk] = mt[kk+M] ^ (y >> 1) ^ mag01[y & 0x1];
801071f5:	89 c6                	mov    %eax,%esi
801071f7:	83 e0 01             	and    $0x1,%eax
801071fa:	d1 ee                	shr    %esi
801071fc:	33 b1 30 06 00 00    	xor    0x630(%ecx),%esi
80107202:	33 34 85 44 7e 10 80 	xor    -0x7fef81bc(,%eax,4),%esi
80107209:	89 71 fc             	mov    %esi,-0x4(%ecx)
        for (kk=0;kk<N-M;kk++) {
8010720c:	39 cb                	cmp    %ecx,%ebx
8010720e:	75 d0                	jne    801071e0 <genrand+0x30>
80107210:	b9 10 ac 10 80       	mov    $0x8010ac10,%ecx
80107215:	8d 76 00             	lea    0x0(%esi),%esi
        }
        for (;kk<N-1;kk++) {
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
80107218:	8b 82 8c 03 00 00    	mov    0x38c(%edx),%eax
8010721e:	8b 9a 90 03 00 00    	mov    0x390(%edx),%ebx
80107224:	83 c2 04             	add    $0x4,%edx
80107227:	81 e3 ff ff ff 7f    	and    $0x7fffffff,%ebx
8010722d:	25 00 00 00 80       	and    $0x80000000,%eax
80107232:	09 d8                	or     %ebx,%eax
            mt[kk] = mt[kk+(M-N)] ^ (y >> 1) ^ mag01[y & 0x1];
80107234:	89 c3                	mov    %eax,%ebx
80107236:	83 e0 01             	and    $0x1,%eax
80107239:	d1 eb                	shr    %ebx
8010723b:	33 5a fc             	xor    -0x4(%edx),%ebx
8010723e:	33 1c 85 44 7e 10 80 	xor    -0x7fef81bc(,%eax,4),%ebx
80107245:	89 9a 88 03 00 00    	mov    %ebx,0x388(%edx)
        for (;kk<N-1;kk++) {
8010724b:	39 d1                	cmp    %edx,%ecx
8010724d:	75 c9                	jne    80107218 <genrand+0x68>
        }
        y = (mt[N-1]&UPPER_MASK)|(mt[0]&LOWER_MASK);
8010724f:	a1 e0 a5 10 80       	mov    0x8010a5e0,%eax
80107254:	8b 0d 9c af 10 80    	mov    0x8010af9c,%ecx
8010725a:	89 c2                	mov    %eax,%edx
8010725c:	81 e1 00 00 00 80    	and    $0x80000000,%ecx
80107262:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
80107268:	09 d1                	or     %edx,%ecx
        mt[N-1] = mt[M-1] ^ (y >> 1) ^ mag01[y & 0x1];
8010726a:	89 ca                	mov    %ecx,%edx
8010726c:	83 e1 01             	and    $0x1,%ecx
8010726f:	d1 ea                	shr    %edx
80107271:	33 15 10 ac 10 80    	xor    0x8010ac10,%edx
80107277:	33 14 8d 44 7e 10 80 	xor    -0x7fef81bc(,%ecx,4),%edx
8010727e:	89 15 9c af 10 80    	mov    %edx,0x8010af9c
80107284:	ba 01 00 00 00       	mov    $0x1,%edx

        mti = 0;
    }
  
    y = mt[mti++];
80107289:	89 15 60 a4 10 80    	mov    %edx,0x8010a460
    y ^= TEMPERING_SHIFT_U(y);
8010728f:	89 c2                	mov    %eax,%edx
80107291:	c1 ea 0b             	shr    $0xb,%edx
80107294:	31 c2                	xor    %eax,%edx
    y ^= TEMPERING_SHIFT_S(y) & TEMPERING_MASK_B;
80107296:	89 d0                	mov    %edx,%eax
80107298:	c1 e0 07             	shl    $0x7,%eax
8010729b:	25 80 56 2c 9d       	and    $0x9d2c5680,%eax
801072a0:	31 c2                	xor    %eax,%edx
    y ^= TEMPERING_SHIFT_T(y) & TEMPERING_MASK_C;
801072a2:	89 d0                	mov    %edx,%eax
801072a4:	c1 e0 0f             	shl    $0xf,%eax
801072a7:	25 00 00 c6 ef       	and    $0xefc60000,%eax
801072ac:	31 d0                	xor    %edx,%eax
    y ^= TEMPERING_SHIFT_L(y);
801072ae:	89 c2                	mov    %eax,%edx
801072b0:	c1 ea 12             	shr    $0x12,%edx
801072b3:	31 d0                	xor    %edx,%eax
...
801072b5:	5b                   	pop    %ebx
    return y & RAND_MAX;
801072b6:	25 ff ff ff 7f       	and    $0x7fffffff,%eax
}
801072bb:	5e                   	pop    %esi
801072bc:	5d                   	pop    %ebp
801072bd:	c3                   	ret    
801072be:	8d 50 01             	lea    0x1(%eax),%edx
801072c1:	8b 04 85 e0 a5 10 80 	mov    -0x7fef5a20(,%eax,4),%eax
801072c8:	eb bf                	jmp    80107289 <genrand+0xd9>
    mt[0]= seed & 0xffffffff;
801072ca:	c7 05 e0 a5 10 80 05 	movl   $0x1105,0x8010a5e0
801072d1:	11 00 00 
801072d4:	b8 e4 a5 10 80       	mov    $0x8010a5e4,%eax
801072d9:	b9 9c af 10 80       	mov    $0x8010af9c,%ecx
801072de:	ba 05 11 00 00       	mov    $0x1105,%edx
801072e3:	eb 06                	jmp    801072eb <genrand+0x13b>
801072e5:	8d 76 00             	lea    0x0(%esi),%esi
801072e8:	83 c0 04             	add    $0x4,%eax
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
801072eb:	69 d2 cd 0d 01 00    	imul   $0x10dcd,%edx,%edx
    for (mti=1; mti<N; mti++)
801072f1:	39 c1                	cmp    %eax,%ecx
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
801072f3:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
801072f5:	75 f1                	jne    801072e8 <genrand+0x138>
801072f7:	e9 d4 fe ff ff       	jmp    801071d0 <genrand+0x20>
801072fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80107300 <random_at_most>:
...
80107307:	8b 45 08             	mov    0x8(%ebp),%eax
    bin_size = num_rand / num_bins,
8010730a:	bb 00 00 00 80       	mov    $0x80000000,%ebx
    num_bins = (unsigned long) max + 1,
8010730f:	8d 48 01             	lea    0x1(%eax),%ecx
    bin_size = num_rand / num_bins,
80107312:	89 d8                	mov    %ebx,%eax
80107314:	f7 f1                	div    %ecx
80107316:	89 c6                	mov    %eax,%esi
80107318:	29 d3                	sub    %edx,%ebx
8010731a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  do {
   x = genrand();
80107320:	e8 8b fe ff ff       	call   801071b0 <genrand>
  }
  // This is carefully written not to overflow
  while (num_rand - defect <= (unsigned long)x);
80107325:	39 d8                	cmp    %ebx,%eax
80107327:	73 f7                	jae    80107320 <random_at_most+0x20>

  // Truncated division is intentional
  return x/bin_size;
80107329:	31 d2                	xor    %edx,%edx
8010732b:	f7 f6                	div    %esi
8010732d:	5b                   	pop    %ebx
8010732e:	5e                   	pop    %esi
8010732f:	5d                   	pop    %ebp
80107330:	c3                   	ret    
